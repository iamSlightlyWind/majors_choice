...
- [x] Proof of concept of running a Tomcat server on Github remote Runner will be tried on the [tomcat branch](https://github.com/iamSlightlyWind/majors_choice/tree/poc_tomcat).
