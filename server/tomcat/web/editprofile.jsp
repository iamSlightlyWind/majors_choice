        ...
        >
          <div class="edit-profile-component-root-form">
            <div class="edit-profile-component-image-usser">
              ...
              <button
                type="button"
                class="edit-profile-component-button-save button thq-button-outline"
              >
                Save&nbsp;
              </button>
            </div>
              ...
              <form action="/editprofile" method="post" onsubmit="return confirmChange();">
                  ...
                  <div class="edit-profile-component-container1"> 
                      <c:if test="${requestScope.status != null}">
                          <span
                              style="margin-top: 32px; margin-right: 32px; color: red;"                             
                              >
                              ${requestScope.status}
                          </span>
                      </c:if>
                      <button
                          type="button"
                          class="edit-profile-component-button button thq-button-outline"
                          >
                          <span>
                      ...
                      <button
                          type="submit"
                          class="edit-profile-component-button1 thq-button-filled button"
                          >
                          Save Edit
                      </button>
                   </div>
