  ...
  <body>
    ...
    <div>
      ...
      <div class="edit-profile-container">
          ...
          <div class="edit-profile-component-container01">
            <div class="edit-profile-component-container02">
              <div class="edit-profile-component-container03">
                ...
                <button
                  type="button"
                  class="edit-profile-component-button button"
                >
                  Save Changes
                </button>
              </div>
            ...
            <div class="edit-profile-component-container04">
              ...
              <div class="edit-profile-component-container06">
                  <form class="edit-profile-component-form" action="/editprofile" method="post" onsubmit="return confirmChange();">
                      ...
                      <c:if test="${requestScope.possition != null}">
                          ...
                          <div class="edit-profile-component-container07">
                              <input
                                  ...
                                  name="id" value="<c:out value="${user.id}"></c:out>" readonly
                                  />
                          </div>
                      </c:if>
                  ...
                  <div class="edit-profile-component-container10">
                    ...
                    <div class="edit-profile-component-container12">
                      <input
                        ...
                        type="password" name="password" value="<c:out value="${user.password}"></c:out>" required
                      />
                    </div>
                  </div>
                </div>
              ...
              <c:if test="${requestScope.possition != null}">
                          ...
                          <div class="edit-profile-component-container07">
                              <input
                                  type="text"
                                  class="edit-profile-component-textinput input"
                                  name="possition" value="<c:out value="${requestScope.possition}"></c:out>" readonly
                                  />
                          </div>
                          ...
                          <div class="edit-profile-component-container07">
                              <input
                                  type="number"
                                  class="edit-profile-component-textinput input"
                                  name="active" value="<c:out value="${user.active}"></c:out>" min="0" max="1" required
                                  />
                          </div>
               </c:if>
                ...
                <div class="edit-profile-component-container14">
                  ...
                  <div class="edit-profile-component-container16">
                    <input
                      ...
                      class="edit-profile-component-textinput2 input"
                      name="phoneNumber" value="<c:out value="${user.phoneNumber}"></c:out>" required
                    />
                  </div>
                </div>
              </div>
             ...
             <div>
              ...
              <div class="edit-profile-component-container30">
                  <button class="edit-profile-component-navlink thq-button-filled button thq-button-outline" type="submit">Save Edit</button>
              </div>
            </div>
          </form>
          </div>
        ...
        <div
          class="contact-contact20 thq-section-padding contact-root-class-name9"
        >
