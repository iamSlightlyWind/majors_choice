<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      <title>editProfile - Major's Choice</title>
      <meta property="og:title" content="editProfile - Major's Choice" />
        ...
        <div class="edit-profile-container">
          ...
          <div class="edit-profile-component-container edit-profile-component-root-class-name">
            <div class="edit-profile-component-root-form">
              <div class="edit-profile-component-image-usser">
                <img alt="image" src="https://play.teleporthq.io/static/svg/default-img.svg"
                  class="edit-profile-component-image" />
                <button type="button" class="edit-profile-component-button-save button thq-button-outline">
                  Save&nbsp;
                </button>
              </div>
              <div class="edit-profile-component-form-infor">
                ...
                <form action="/editprofile" method="post" onsubmit="return confirmChange();">
                  ...
                  <div class="edit-profile-component-user-name">
                    ...
                    <input type="text" required="true" class="edit-profile-component-textinput input" name="username"
