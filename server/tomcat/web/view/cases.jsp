            ...
            <div class="view-category-body">
              ...
              <div class="view-category-product">
                <div class="view-category-container01">
                  ...
                  <form class="view-category-form" action="/FilterCase" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="view-category-form">
                      <span class="view-category-text14">
                        <span>FormFactors</span>
                        <br />
                      </span>
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="formFactors" value="Mid Tower"
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="formFactors" value="FullTower"
                          <c:forEach var="formFactor" items="${formFactors}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="formFactors" value="Mini ITX"
                          <c:forEach var="formFactor" items="${formFactors}">
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="colors" value="White" <c:forEach
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="colors" value="Black" <c:forEach
                          var="color1" items="${colors}">
