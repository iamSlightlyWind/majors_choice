          ...
          <div class="view-detail-product-infor-product">
            ...
            <div class="view-detail-product-name-price">
              <span class="view-detail-product-text03">
                  <span> <c:if test="${category == 'cpu'}">
                          ${product.name}/${product.baseClock}GHz Boost ${product.boostClock}GHz/${product.cores} Cores/${product.threads} Threads/${product.socket} 
                      </c:if>
                      <c:if test="${category == 'gpu'}">
                                  ...
                                  <div class="view-detail-product-name-vs-date">
                                      ...
                                      <span class="view-detail-product-date-time">
                                          <date-time-primitive
                                              ...
                                              ><%=rate.dateRated%></date-time-primitive>
                                      </span>
                                  </div>
                ...
                <c:if test="${order != null && rateStatus == 0}">
                    ...
                    <form action="/product/rate" method="post">                       
                        <div class="view-detail-product-average-rating">
                            <span class="view-detail-product-average">
                        ...
                        <input type="text" name="rateText"/><br><br>
                  ...
                  <c:if test="${rate != null && rateStatus == 1}">
                    ...
                    <form action="/product/rate" method="post">                       
                        ...
                        <label for="feedback">Your Feedback:</label><br>
                        <input type="text" name="rateText" value="${rate.ratingText}"/><br><br>
                        <div class="view-detail-product-total-reviews">
                            <strong class="view-detail-product-number-review">(3)</strong>
                            <span class="view-detail-product-text43">
                                &nbsp;reviews &amp; comments
