                ...
                <header data-thq="thq-navbar" class="navbar-navbar-interactive">
                  ...
                  <div data-thq="thq-navbar-nav" class="navbar-desktop-menu">
                    <nav class="navbar-links">
                      <form action="/psusservlet" method="post">
          ...
          <div class="view-all-product-cpu-body">
            ...
            <div class="view-all-product-cpu-product">
              <div class="view-all-product-cpu-container01">
                ...
                <form class="view-all-product-cpu-form" action="/filterpsu" method="post"
                  ...
                  <div class="view-all-product-cpu-container03">
                    ...
                    <input type="number" id="from" placeholder="min " class="view-all-product-cpu-textinput input"
                      name="fromWattage" value="${requestScope.fromWattages}" />
                  </div>
                  <div class="view-all-product-cpu-container04">
                    <span class="view-all-product-cpu-text11">
                      <span>To</span>
                    ...
                    <input type="number" id="to" placeholder="max" class="view-all-product-cpu-textinput1 input"
                      name="toWattage" value="${requestScope.toWattages}" />
                  </div>
                  <hr>
                  ...
                  <div class="view-all-product-cpu-container05">
                    <input type="checkbox" class="view-all-product-cpu-checkbox" name="efficiency" value="80+ platin"
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="efficiency" value="80+ gold"
                      <c:forEach var="efficiency" items="${efficiencys}">
                  ...
                  <div class="view-all-product-cpu-container07">
                    <input type="checkbox" class="view-all-product-cpu-checkbox2" name="efficiency" value="80+ titani"
                      <c:forEach var="efficiency" items="${efficiencys}">
              ...
              <div class="view-all-product-cpu-container09">
                <c:forEach var="psu" items="${requestScope.psus}">
                    ...
                    <span class="component1-text1">
                      ...
                      <fmt:formatNumber value="${psu.sellingPrice}" type="number" pattern="#,###,###" var="formattedSellingPrice" />
