    ...
    <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <div class="view-category-body">
              ...
              <div class="view-category-product">
                <div class="view-category-container01">
                  ...
                  <form class="view-category-form" action="/FilterPSU" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container03">
                        ...
                        <input placeholder="Watt " type="number" id="Wfrom" name="fromWattage"
                          value="${requestScope.fromWattages}" class="view-category-textinput input" />
                      </div>
                      <div class="view-category-container04">
                        <span class="view-category-text11">
                          <span>To</span>
                        ...
                        <input type="number" id="Wto" name="toWattage" value="${requestScope.toWattages}"
                          placeholder="Watt " class="view-category-textinput1 input" />
                      </div>
                    </div>
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="efficiency" value="80+ platin"
                          <c:forEach var="efficiency" items="${efficiencys}">
                        <c:if test="${efficiency == '80+ platin' || efficiency == '80platin'}">
                          checked
                        </c:if>
                        </c:forEach>
                        />
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="efficiency" value="80+ gold"
                          <c:forEach var="efficiency" items="${efficiencys}">
                        <c:if test="${efficiency == '80+ gold' || efficiency == '80gold'}">
                          checked
                        </c:if>
                        </c:forEach>
                        />
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="efficiency" value="80+ titani"
                          <c:forEach var="efficiency" items="${efficiencys}">
                        <c:if test="${efficiency == '80+ titani' || efficiency == '80titani'}">
                          checked
                        </c:if>
                        </c:forEach>
                        />
                ...
                <div class="view-category-container09">
                  <c:forEach var="psu" items="${requestScope.psus}">
                      ...
                      <div class="product-container product-root-class-name116">
                        ...
                        <span class="product-text1">
                          <span>
                            ...
                            <fmt:formatNumber value="${psu.sellingPrice}" type="number" pattern="#,###,###"
      ...
      <script>
        function validateForm() {
          ...
          if (Wfrom < 0 || Wto < 0) {
            alert("Please enter valid numbers for 'From' and 'To' in Wattage.");
            return false;
          }

          if (Cfrom > Cto) {
            alert("The 'From' value cannot be greater than the 'To' value in Wattage. Please enter again.");
            return false;
          }
