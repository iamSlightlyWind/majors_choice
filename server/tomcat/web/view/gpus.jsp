              ...
              <div class="view-category-body">
                ...
                <div class="view-category-product">
                  <div class="view-category-container01">
                    ...
                    <form class="view-category-form" action="/FilterGPU" method="post" onsubmit="return validateForm()">
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="generation" value="rdna"
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" name="generation" value="ampere" class="view-category-checkbox1"
                            <c:forEach var="generation" items="${generations}">
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="generation" value="ada lovelace"
                            <c:forEach var="generation" items="${generations}">
