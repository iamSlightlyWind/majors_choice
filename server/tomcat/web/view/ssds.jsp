      ...
      <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
              ...
              <div class="view-category-body">
                ...
                <div class="view-category-product">
                  <div class="view-category-container01">
                    ...
                    <form class="view-category-form" action="/FilterSSD" method="post" onsubmit="return validateForm()">
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                            <input type="checkbox" class="view-category-checkbox" name="interfaces" value="PCIe 3.0"
                        ...
                        <div class="view-category-container06">
                            <input type="checkbox" class="view-category-checkbox1"
                                   name="interfaces" value="PCIe 4.0"
                                   <c:forEach var="interfacee" items="${interfaces}">
                          ...
                          <div class="view-category-container06">
                            <input type="checkbox" class="view-category-checkbox1"
                                   name="interfaces" value="SATA 2.5"
                      <c:forEach var="interfacee" items="${interfaces}">
                    <c:if test="${interfacee == 'SATA 2.5' || interfacee == 'SATA25'}">
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container03">
                          ...
                          <input placeholder="min " type="number" id="Cfrom" name="fromCapacity" value="${requestScope.fromCapacity}" class="view-category-textinput input" />
                        </div>
                        <div class="view-category-container04">
                          <span class="view-category-text11">
                            <span>To</span>
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="cache" value="0" <c:forEach
                      var="cache" items="${caches}">
                    <c:if test="${cache == '0'}">
                      checked
                    </c:if>
                    </c:forEach>
        ...
        <script>
          function validateForm() {
            ...
            var Cfrom = parseFloat(document.getElementById("Cfrom").value);
            var Cto = parseFloat(document.getElementById("Cto").value);
