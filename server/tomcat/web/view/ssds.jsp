                  ...
                  <form class="view-category-form" action="/FilterSSD" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="interfaces" value="PCIe 4.0"
                          <c:forEach var="interfacee" items="${interfaces}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="interfaces" value="SATA 2.5"
                          <c:forEach var="interfacee" items="${interfaces}">
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="cache" value="1" <c:forEach
                          var="cache" items="${caches}">
                        <c:if test="${cache == '1'}">
                          checked
                        </c:if>
