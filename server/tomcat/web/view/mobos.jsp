                 ...
                 <div class="view-category-form">
                     ...
                     <div class="view-category-container05">
                         <input
                             ...
                             name="socket" value="am4" <c:forEach
                    ...
                    <c:if test="${socket == 'am4'}">
                     ...
                     <div class="view-category-container06">
                         <input
                            ...
                            name="socket" value="am5" <c:forEach
                      var="socket" items="${sockets}">
                 ...
                 <div class="view-category-form">
                     ...
                     <div class="view-category-container05">
                         <input
                             type="checkbox"
                             class="view-category-checkbox"
                             name="ramType" value="ddr4" <c:forEach
                    ...
                    <c:if test="${ramType == 'ddr4'}">
                     ...
                     <div class="view-category-container06">
                         <input
                             type="checkbox"
                             class="view-category-checkbox1"
                             name="ramType" value="ddr5" <c:forEach
                      var="ramType" items="${ramTypes}">
