                ...
                <header data-thq="thq-navbar" class="navbar-navbar-interactive">
                  ...
                  <div data-thq="thq-navbar-nav" class="navbar-desktop-menu">
                    <nav class="navbar-links">
                      <form action="/mobosservlet" method="post">
          ...
          <div class="view-all-product-cpu-body">
            ...
            <div class="view-all-product-cpu-product">
              <div class="view-all-product-cpu-container01">
                ...
                <form class="view-all-product-cpu-form" action="/filtermobo" method="post"
                  ...
                  <div class="view-all-product-cpu-container05">
                    <input type="checkbox" class="view-all-product-cpu-checkbox" name="formFactor" value="atx"
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="formFactor" value="matx"
                      <c:forEach var="formFactor" items="${formFactors}">
                  ...
                  <div class="view-all-product-cpu-container07">
                    <input type="checkbox" class="view-all-product-cpu-checkbox2" name="formFactor" value="mITX"
                      <c:forEach var="formFactor" items="${formFactors}">
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="ramType" value="ddr4" <c:forEach
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="ramType" value="ddr5" <c:forEach
                      var="ramType" items="${ramTypes}">
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="wifi" value="1" <c:forEach
                      var="wifi" items="${wifi}">
                    <c:if test="${wifi == '1'}">
                      checked
                    </c:if>
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="wifi" value="0" <c:forEach
                      var="wifi" items="${wifi}">
                    <c:if test="${wifi == '0'}">
                      checked
                    </c:if>
              ...
              <div class="view-all-product-cpu-container09">
                <c:forEach var="mobo" items="${requestScope.mobos}">
                    ...
                    <span class="component1-text1">
                      ...
                      <fmt:formatNumber value="${mobo.sellingPrice}" type="number" pattern="#,###,###" var="formattedSellingPrice" />
