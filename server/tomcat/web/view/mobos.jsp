              ...
              <div class="view-category-body">
                <div class="view-category-link-page">
                  ...
                  <span class="view-category-text01">
                    / <a href="/CPU">MotherBoard -&nbsp;Computer processor</a>
                  </span>
                </div>
                <div class="view-category-product">
                  <div class="view-category-container01">
                    ...
                    <form class="view-category-form" action="/FilterMotherBoard" method="post"
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="socket" value="am4" <c:forEach
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="socket" value="am5" <c:forEach
                            var="socket" items="${sockets}">
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="socket" value="lga 1700"
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="formFactor" value="atx" <c:forEach
                            var="formFactor" items="${formFactors}">
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="formFactor" value="matx"
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="formFactor" value="mITX"
                            <c:forEach var="formFactor" items="${formFactors}">
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="ramType" value="ddr4" <c:forEach
                            var="ramType" items="${ramTypes}">
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="ramType" value="ddr5" <c:forEach
                            var="ramType" items="${ramTypes}">
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="wifi" value="1" <c:forEach
                            var="wifi" items="${wifi}">
                          <c:if test="${wifi == '1'}">
                            checked
                          </c:if>
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="wifi" value="0" <c:forEach
                            var="wifi" items="${wifi}">
                          <c:if test="${wifi == '0'}">
                            checked
                          </c:if>
                  ...
                  <div class="view-category-container09">
                    <c:forEach var="mobo" items="${requestScope.mobos}">
                        ...
                        <div class="product-container product-root-class-name116">
                          ...
                          <span class="product-text1">
                            <span>
                              ...
                              <fmt:formatNumber value="${mobo.sellingPrice}" type="number" pattern="#,###,###"
                                var="moboSellingPrice" />
                              <span id="sellingPrice">${moboSellingPrice}<u>đ</u></span>
                            </span>
                            <br />
                          </span>
