                    ...
                    <a href="/view/detail/product?category=gpu&id=${gpu.id}" rel="noreferrer noopener">
                      <div class="product-container product-root-class-name116">
                        ...
                        <span class="product-text1">
                          <span>
                            <fmt:setLocale value="vi_VN" />
                            <fmt:formatNumber value="${gpu.sellingPrice}" type="number" pattern="#,###,###"
                              var="gpuSellingPrice" />
                    ...
                    <a href="/view/detail/product?category=ssd&id=${ssd.id}" rel="noreferrer noopener">
                      <div class="product-container product-root-class-name116">
                        ...
                        <span class="product-text1">
                          <span>
                            <fmt:setLocale value="vi_VN" />
                            <fmt:formatNumber value="${ssd.sellingPrice}" type="number" pattern="#,###,###"
                              var="ssdSellingPrice" />
                    ...
                    <a href="/view/detail/product?category=case&id=${case1.id}" rel="noreferrer noopener">
                      <div class="product-container product-root-class-name116">
                        ...
                        <span class="product-text1">
                          <span>
                            <fmt:setLocale value="vi_VN" />
                            <fmt:formatNumber value="${case1.sellingPrice}" type="number" pattern="#,###,###"
                              var="caseSellingPrice" />
