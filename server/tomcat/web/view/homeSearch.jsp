<%@page contentType="text/html" pageEncoding="UTF-8" %>
  ...
  <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <head>
      <title>ViewAllProductCPU - Major's Choice</title>
      <meta property="og:title" content="ViewAllProductCPU - Major's Choice" />
              ...
              <div class="view-all-product-cpu-container09" style="margin-left: 17%;">
                 ...
                 <c:forEach var="cpu" items="${requestScope.cpus}">
                    ...
                    <span class="component1-text1">
                      ...
                      <fmt:formatNumber value="${cpu.sellingPrice}" type="number" pattern="#,###,###" var="cpuSellingPrice" />
                      <span>${cpuSellingPrice}<u>đ</u></span>
                      <br />
                    </span>
                 ...
                 <c:forEach var="gpu" items="${requestScope.gpus}">
                    ...
                    <span class="component1-text1">
                      ...
                      <span>${gpuSellingPrice}<u>đ</u></span>
                      <br />
                    </span>
                    <div class="component1-container1">
                      <span class="component1-text4"><span>0.0</span></span>
                 ...
                 <c:forEach var="mobo" items="${requestScope.mobos}">
                    ...
                    <span class="component1-text1">
                      ...
                      <span>${moboSellingPrice}<u>đ</u></span>
                      <br />
                    </span>
                    <div class="component1-container1">
                      <span class="component1-text4"><span>0.0</span></span>
                 ...
                 <c:forEach var="ram" items="${requestScope.rams}">
                    ...
                    <span class="component1-text1">
                      ...
                      <span>${ramSellingPrice}<u>đ</u></span>
                      <br />
                    </span>
                    <div class="component1-container1">
                      <span class="component1-text4"><span>0.0</span></span>
                 ...
                 <c:forEach var="ssd" items="${requestScope.ssds}">
                    <a href="/view/detail/product?category=cpu&id=${ssd.id}">
                    <div class="component1-container component1-root-class-name">
                    <img alt="image"
                      src="./css/image/amd800h.webp"
                      loading="eager" class="component1-image" />
                    ...
                    <span class="component1-text1">
                      ...
                      <span>${ssdSellingPrice}<u>đ</u></span>
                      <br />
                    </span>
                    <div class="component1-container1">
                      <span class="component1-text4"><span>0.0</span></span>
                 ...
                 <c:forEach var="case1" items="${requestScope.cases}">
                    <a href="/view/detail/product?category=cpu&id=${case1.id}">
                    <div class="component1-container component1-root-class-name">
                    <img alt="image"
                      src="./css/image/amd800h.webp"
                      loading="eager" class="component1-image" />
                    ...
                    <span class="component1-text1">
                      ...
                      <span>${caseSellingPrice}<u>đ</u></span>
                      <br />
                    </span>
                    <div class="component1-container1">
                      <span class="component1-text4"><span>0.0</span></span>
