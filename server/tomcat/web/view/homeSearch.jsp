      ...
      <div class="view-category-container">
        ...
        <div class="view-category-body">
          ...
          <div class="view-category-product">
            <div class="view-category-container09" style="margin-left: 10%;">
              ...
              >
                <div class="product-container product-root-class-name116">
                  ...
                  <span class="product-text1">
                    <span>
                        <fmt:setLocale value="vi_VN"/>
                      <fmt:formatNumber value="${gpu.sellingPrice}" type="number" pattern="#,###,###" var="gpuSellingPrice" />
                      <span id="sellingPrice">${gpuSellingPrice}<u>đ</u></span>
                    </span>
                    <br />
                  </span>
                  <div class="product-container1">
              ...
              >
                <div class="product-container product-root-class-name116">
                  ...
                  <span class="product-text1">
                    <span>
                        <fmt:setLocale value="vi_VN"/>
                      <fmt:formatNumber value="${mobo.sellingPrice}" type="number" pattern="#,###,###" var="moboSellingPrice" />
              ...
              >
                <div class="product-container product-root-class-name116">
                  ...
                  <span class="product-text1">
                    <span>
                        <fmt:setLocale value="vi_VN"/>
                      <fmt:formatNumber value="${psu.sellingPrice}" type="number" pattern="#,###,###" var="psuSellingPrice" />
                      <span id="sellingPrice">${psuSellingPrice}<u>đ</u></span>
                    </span>
                    <br />
                  </span>
                  <div class="product-container1">
              ...
              >
                <div class="product-container product-root-class-name116">
                  ...
                  <span class="product-text1">
                    <span>
                        <fmt:setLocale value="vi_VN"/>
                      <fmt:formatNumber value="${ram.sellingPrice}" type="number" pattern="#,###,###" var="ramSellingPrice" />
                      <span id="sellingPrice">${ramSellingPrice}<u>đ</u></span>
                    </span>
                    <br />
                  </span>
                  <div class="product-container1">
                ...
                <a
                href="/view/detail/product?category=ssd&id=${ssd.id}"
                rel="noreferrer noopener"
              >
                <div class="product-container product-root-class-name116">
                  <img
                  ...
                  <span class="product-text1">
                    <span>
                        <fmt:setLocale value="vi_VN"/>
                      <fmt:formatNumber value="${ssd.sellingPrice}" type="number" pattern="#,###,###" var="ssdSellingPrice" />
                      <span id="sellingPrice">${ssdSellingPrice}<u>đ</u></span>
                    </span>
                    <br />
                  </span>
                  <div class="product-container1">
              ...
              >
                <div class="product-container product-root-class-name116">
                  ...
                  <span class="product-text1">
                    <span>
                        <fmt:setLocale value="vi_VN"/>
                       <fmt:formatNumber value="${case1.sellingPrice}" type="number" pattern="#,###,###" var="caseSellingPrice" /> 
                      <span id="sellingPrice">${caseSellingPrice}<u>đ</u></span>
                    </span>
                    <br />
                  </span>
                  <div class="product-container1">
