<%-- Document : cpus1 Created on : Jul 11, 2024, 4:53:20 PM Author : thang --%>
                  ...
                  <div class="view-category-container01">
                     ...
                     <c:set var="generations" value="${requestScope.generations}" />
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="generations" value="ddr4"
                    ...
                    <c:if test="${generation == 'ddr4'}">
                      checked
                        ...
                        <div class="view-category-container06">
                            <input type="checkbox" class="view-category-checkbox1"
                                   name="generations" value="ddr5"
                                   <c:forEach var="generation" items="${generations}">
                    ...
                    <c:if test="${capacityss == '16'}">
                      checked
                        ...
                        <div class="view-category-container06">
                            <input type="checkbox" class="view-category-checkbox1"
                                  name="capacity" value="32" <c:forEach
                      var="capacityss" items="${capacitys}">
                    <c:if test="${capacityss == '32'}">
                      checked
                          ...
                          <div class="view-category-container06">
                            <input type="checkbox" class="view-category-checkbox1"
                                   name="capacity" value="64" <c:forEach
                      var="capacityss" items="${capacitys}">
