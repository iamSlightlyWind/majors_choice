    ...
    <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
        ...
        <div>
          ...
          <div class="view-category-container">
                      ...
                      <nav class="navmain-links">
                        <form action="/RAM" method="post">
                          <div class="navmain-container3">
                            <input type="text" placeholder="Search for product" name="searchName"
                              value="${requestScope.searchName}" class="navmain-textinput input" />
            ...
            <div class="view-category-body">
              ...
              <div class="view-category-product">
                <div class="view-category-container01">
                  ...
                  <form class="view-category-form" action="/FilterRAM" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="generations" value="ddr4" <c:forEach
                          var="generation" items="${generations}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="generations" value="ddr5"
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="speed" value="3000" <c:forEach
                          var="speed" items="${requestScope.speeds}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="speed" value="3200" <c:forEach
                          var="speed" items="${requestScope.speeds}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="speed" value="3600" <c:forEach
                          var="speed" items="${requestScope.speeds}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="speed" value="5600" <c:forEach
                          var="speed" items="${requestScope.speeds}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="speed" value="6000" <c:forEach
                          var="speed" items="${requestScope.speeds}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="speed" value="6400" <c:forEach
                          var="speed" items="${requestScope.speeds}">
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="latencys" value="15" <c:forEach
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="latencys" value="16" <c:forEach
                          var="speed" items="${requestScope.latencys}">
                        <c:if test="${speed == '16'}">
                          checked
                        </c:if>
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="latencys" value="18" <c:forEach
                          var="speed" items="${requestScope.latencys}">
                        <c:if test="${speed == '18'}">
                          checked
                        </c:if>
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="latencys" value="36" <c:forEach
                          var="speed" items="${requestScope.latencys}">
                        <c:if test="${speed == '36'}">
                          checked
                        </c:if>
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="latencys" value="38" <c:forEach
                          var="speed" items="${requestScope.latencys}">
                        <c:if test="${speed == '38'}">
                          checked
                        </c:if>
                    ...
                    <div class="view-category-form">
                      ...
                      <div class="view-category-container05">
                        <input type="checkbox" class="view-category-checkbox" name="capacity" value="16" <c:forEach
                          var="capacityss" items="${capacitys}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="capacity" value="32" <c:forEach
                          var="capacityss" items="${capacitys}">
                      ...
                      <div class="view-category-container06">
                        <input type="checkbox" class="view-category-checkbox1" name="capacity" value="64" <c:forEach
                          var="capacityss" items="${capacitys}">
                    ...
                    <button type="submit" value="Filter" class="view-category-button button thq-button-outline">
                      <span>
                        <span>Filter</span>
                        <br />
                      </span>
                ...
                <div class="view-category-container09">
                  <c:forEach var="ram" items="${requestScope.rams}">
                      ...
                      <div class="product-container product-root-class-name116">
                        ...
                        <span class="product-text1">
                          <span>
                            ...
                            <fmt:formatNumber value="${ram.sellingPrice}" type="number" pattern="#,###,###"
            ...
            <div class="view-category-footer">
              <footer class="footer-footer1 thq-section-padding footer-root-class-name4">
      ...
      <script>
        function validateForm() {
          ...
          var Cfrom = parseFloat(document.getElementById("Corefrom").value);
          var Cto = parseFloat(document.getElementById("Coreto").value);
