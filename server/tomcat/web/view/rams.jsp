            ...
            <div class="view-all-product-cpu-product">
              <div class="view-all-product-cpu-container01">
                ...
                <form class="view-all-product-cpu-form" action="/FilterRAM" method="post"
                  ...
                  <div class="view-all-product-cpu-container07">
                    <input type="checkbox" class="view-all-product-cpu-checkbox2" name="speed" value="6400" <c:forEach
                      var="speed" items="${requestScope.speeds}">
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="capacity" value="16" <c:forEach
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="capacity" value="32" <c:forEach
                      var="capacityss" items="${capacitys}">
                  ...
                  <div class="view-all-product-cpu-container06">
                    <input type="checkbox" class="view-all-product-cpu-checkbox1" name="capacity" value="64" <c:forEach
                      var="capacityss" items="${capacitys}">
