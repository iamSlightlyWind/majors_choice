              ...
              <div class="view-category-body">
                ...
                <div class="view-category-product">
                  <div class="view-category-container01">
                    ...
                    <form class="view-category-form" action="/FilterCPU" method="post" onsubmit="return validateForm()">
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="brand" value="amd" <c:forEach
                      ...
                      <div class="view-category-form">
                        ...
                        <div class="view-category-container05">
                          <input type="checkbox" class="view-category-checkbox" name="generation" value="Cezanne"
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" name="generation" value="Zen 3" class="view-category-checkbox1"
                            <c:forEach var="generation" items="${generations}">
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="generation" value="raphael"
                            <c:forEach var="generation" items="${generations}">
                        ...
                        <div class="view-category-container06">
                          <input type="checkbox" class="view-category-checkbox1" name="generation" value="raptor lake"
                            <c:forEach var="generation" items="${generations}">
                        ...
                        <div class="product-container product-root-class-name116">
                          ...
                          <span class="product-text1">
                            <span>
                              ...
                              <fmt:formatNumber value="${cpu.sellingPrice}" type="number" pattern="#,###,###"
