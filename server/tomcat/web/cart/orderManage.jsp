<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      <title>Manage Order - Major's Choice</title>
      <meta property="og:title" content="Manage Order - Major's Choice" />
    ...
    <body>
      ...
      <div>
        ...
        <div class="manage-list-order-container">
          <div class="manage-list-order-header">
            <div class="navmain-container navmain-root-class-name52">
          ...
          <div class="manage-list-order-body">
            <div class="manage-list-order-link-page">
              <span class="manage-list-order-text thq-body-small thq-link">
                Home&nbsp;
              </span>
              <span class="manage-list-order-text01">/ Manager Orders</span>
            </div>
            <div class="manage-list-order-root-form">
              <div class="manage-list-order-heading-table"></div>
              <div class="manage-list-order-table">
                <h1 class="manage-list-order-text02">Manage Orders</h1>
                <div class="manage-list-order-control">
                  <div class="manage-list-order-container1">
                    <form action="/manage/order" method="get">
                      <button type="submit" name="action" value="viewAll">
                        <span style="font-weight: 400;" class="manage-list-order-text03 thq-link">
                          <c:out value="${empty view ? '<b>All</b>' : 'All'}" escapeXml="false" />
                        </span>
                      </button>
                      <button type="submit" name="action" value="viewPending">
                        <span style="font-weight: 400;" class="manage-list-order-text04 thq-link">
                          <span>${view == 'Pending' ? '<b>Pending</b>' : 'Pending'}</span>
                          <br />
                        </span>
                      </button>
                      <button type="submit" name="action" value="viewRequested">
                        <span style="font-weight: 400;" class="manage-list-order-text07 thq-link">
                          <span>${view == 'Requested' ? '<b>Requested</b>' : 'Requested'}</span>
                          <br />
                        </span>
                      </button>
                      <button type="submit" name="action" value="viewDenied">
                        <span style="font-weight: 400;" class="manage-list-order-text10 thq-link">
                          <span>${view == 'Denied' ? '<b>Denied</b>' : 'Denied'}</span>
                          <br />
                        </span>
                      </button>
                      <button type="submit" name="action" value="viewCancelled">
                        <span style="font-weight: 400;" class="manage-list-order-text13 thq-link">
                          <span>${view == 'Cancelled' ? '<b>Cancelled</b>' : 'Cancelled'}</span>
                          <br />
                        </span>
                      </button>
                      <button type="submit" name="action" value="viewShipping">
                        <span style="font-weight: 400;" class="manage-list-order-text16 thq-link">
                          <span>${view == 'Shipping' ? '<b>Shipping</b>' : 'Shipping'}</span>
                          <br />
                        </span>
                      </button>
                      <button type="submit" name="action" value="viewCompleted">
                        <span style="font-weight: 400;" class="manage-list-order-text19 thq-link">
                          <span>${view == 'Completed' ? '<b>Completed</b>' : 'Completed'}</span>
                          <br />
                        </span>
                      </button>
                    </form>
                  </div>
                  <div class="manage-list-order-search-product">
                    <c:choose>
                      <c:when test="${not empty searchError}">
                        <input type="text" id="orderId" name="id" placeholder="${searchError}"
                          class="manage-list-order-textinput input error-placeholder" />
                      </c:when>
                      <c:otherwise>
                        <input type="text" id="orderId" placeholder="Order ID"
                          class="manage-list-order-textinput input" />
                      </c:otherwise>
                    </c:choose>
                    <button onclick="viewDetails()" name="action" value="viewDetails"
                      class="manage-list-order-search thq-button-filled">
                      <span class="manage-list-order-text22 thq-body-small">
                        <span>View</span>
                        <br />
                      </span>
                    </button>
                ...
                <div class="manage-list-order-list-detail">
                  <form class="manage-list-order-form-tittle">
                    <div class="manage-list-order-id">
                      <span class="manage-list-order-text25">Order ID</span>
                    </div>
                    <div class="manage-list-order-date">
                      <span class="manage-list-order-text26">
                        <span>Date</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-order-customer">
                      <span class="manage-list-order-text29">
                        <span>Customer</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-order-status">
                      <span class="manage-list-order-text32">
                        <span>Status</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-order-items">
                      <span class="manage-list-order-text35">
                        <span>Items</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-order-total">
                      <span class="manage-list-order-text38">
                        <span>Total</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-order-payment-mothod">
                      <span class="manage-list-order-text41">Payment Method</span>
                    </div>
                  </form>
                  <c:forEach var="Order" items="${OrderList}">
                    <form class="manage-list-order-form-order1" action="/order" method="get">
                      <input type="hidden" name="id" value="${Order.id}" />
                      <div class="manage-list-order-id1">
                        <span class="manage-list-order-text42">
                          <span>${Order.id}</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-order-date1">
                        <span class="manage-list-order-text45">
                          <span>${Order.date}</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-order-customer1">
                        <span class="manage-list-order-text48">${Order.user.fullName}</span>
                      </div>
                      <div class="manage-list-order-status1">
                        <span class="manage-list-order-text49">
                          <span>${Order.status}</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-order-items1">
                        <span class="manage-list-order-text52">
                          <span>${Order.count}</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-order-total1">
                        <span class="manage-list-order-text55">
                          <span>${Order.cartTotal} VND</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-order-payment-medthod">
                        <span class="manage-list-order-text58">
                          <span>${Order.paymentMethod}</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-order-view">
                        <button type="submit" name="action" value="viewDetails">
                          <svg viewBox="0 0 1024 1024" class="manage-list-order-icon thq-button-icon teleport-show">
                            <path
                              d="M950.857 548.571c-54.286-84-128.571-156-217.714-201.714 22.857 38.857 34.857 83.429 34.857 128.571 0 141.143-114.857 256-256 256s-256-114.857-256-256c0-45.143 12-89.714 34.857-128.571-89.143 45.714-163.429 117.714-217.714 201.714 97.714 150.857 255.429 256 438.857 256s341.143-105.143 438.857-256zM539.429 329.143c0-14.857-12.571-27.429-27.429-27.429-95.429 0-173.714 78.286-173.714 173.714 0 14.857 12.571 27.429 27.429 27.429s27.429-12.571 27.429-27.429c0-65.143 53.714-118.857 118.857-118.857 14.857 0 27.429-12.571 27.429-27.429zM1024 548.571c0 14.286-4.571 27.429-11.429 39.429-105.143 173.143-297.714 289.714-500.571 289.714s-395.429-117.143-500.571-289.714c-6.857-12-11.429-25.143-11.429-39.429s4.571-27.429 11.429-39.429c105.143-172.571 297.714-289.714 500.571-289.714s395.429 117.143 500.571 289.714c6.857 12 11.429 25.143 11.429 39.429z">
                            </path>
                          </svg>
                        </button>
                      </div>
          ...
          <footer class="footer-footer1 thq-section-padding footer-root-class-name47">
      ...
      <script>
        function viewDetails() {
          ...
          if (orderId) {
            window.location.href = '/order?id=' + encodeURIComponent(orderId) + '&action=viewDetails';
          }
        }
      </script>
