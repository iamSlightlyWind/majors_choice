  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
      ...
      <div>
        ...
        <div class="customer-order-list-container">
          <div class="customer-order-list-container01">
            <div class="navmain-container navmain-root-class-name1">
          ...
          <div class="customer-order-list-container04"></div>
          <c:forEach var="Order" items="${OrderList}">
            <div class="customer-order-list-container05">
              <form class="customer-order-list-form">
                <span class="customer-order-list-text10">Order ID: ${Order.id}</span>
                <span class="customer-order-list-text11">Status: ${Order.status}</span>
              </form>
              <c:forEach var="ProductCount" items="${Order.quantities}">
                <div class="customer-order-list-form3">
                  ...
                  <div class="customer-order-list-container08">
                    ...
                    <span class="customer-order-list-text23">
                      <span>x${ProductCount.count}</span>
                      <br />
                    </span>
                  </div>
              ...
              <div class="customer-order-list-form4">
                <div class="customer-order-list-container09">
                  <span class="customer-order-list-text27">
                    <span>Total:&nbsp;</span>
                    <br />
                  </span>
                  <span class="customer-order-list-text30">${Order.cartTotal} VND</span>
                </div>
                <div class="customer-order-list-container10">
                  <form action="/order" method="get">
                    <input type="hidden" name="id" value="${Order.id}" />
                    <button type="submit" name="action" value="viewDetails"
                      class="customer-order-list-button button thq-button-outline">
                      View Detail
                    </button>
                  </form>
                </div>
          ...
          <footer class="footer-footer1 thq-section-padding footer-root-class-name49">
