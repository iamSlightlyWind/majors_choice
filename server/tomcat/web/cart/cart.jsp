                ...
                <div data-thq="thq-navbar-nav" class="navbar-desktop-menu">
                  <nav class="navbar-links">
                    ...
                    <div class="navbar-container4">
                      ...
                      <a href="/order" class="navbar-manager-order thq-body-small thq-link">
                        Manage Order
                      </a>
                    </div>
                  </nav>
                  <div class="navbar-buttons">
                    <a href="/cart" target="_blank" rel="noreferrer noopener" class="navbar-link1">
                    ...
                    <a href="/profile?action=view" target="_blank" rel="noreferrer noopener"
          ...
          <% String role=(String) request.getSession().getAttribute("role"); if ("staff".equals(role) || "manager"
            ...
            <div class="menu-function-container menu-function-root-class-name22">
              <div class="menu-function-manager">
                ...
                <a href="/manage/profile/user" class="menu-function-mgt-customer text1 thq-link1 thq-body-small">
                  Manage Customer
                </a>
                ...
                <a href="/manage/profile/staff" class="menu-function-mgt-staff text1 thq-link1 thq-body-small">
                  Manage Staff
                </a>
                        ...
                        <form action="Cart" method="post">
                          ...
                          <div class="view-cart-component-container07">
                            <button type="submit" name="action" value="removeOne"
                              class="view-cart-component-button button">
                              <span>
                                <span>-</span>
                                <br />
                              </span>
                            ...
                            <button button type="submit" name="action" value="addOne"
                              class="view-cart-component-button1 button">
                              <span>+</span>
                            </button>
                          </div>
                          <div class="view-cart-component-container08">
                            <span class="view-cart-component-text14">${ProductCount.totalPrice} VND</span>
                            <button button type="submit" name="action" value="removeAll"
                              class="view-cart-component-button2 thq-button-filled button">
                              X
                            </button>
                          </div>
                        </form>
                    ...
                    <div class="view-cart-component-container10">
                      ...
                      <form action="Cart" method="post">
                        <button type="submit" name="action" value="clear"
                          class="view-cart-component-button3 button thq-button-outline">
