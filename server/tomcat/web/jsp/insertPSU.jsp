                            ...
                            <form action="/psus?service=insertPSU" method="post" enctype="multipart/form-data">
                                ...
                                <div class="manage-product-add-form04">
                                    ...
                                    <div class="manage-product-add-container03">
                                        <input type="number" placeholder="Number" name="wattage" class="manage-product-add-textinput04 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form05">
                                    ...
                                    <div class="manage-product-add-container04">
                                        <input type="text" placeholder="Text" name="efficiency" class="manage-product-add-textinput05 input" />
                                    </div>
                                </div>                                
                                ...
                                <div class="manage-product-add-container13">
                                    <input type="submit" name="submit" value="Add PSU" class="manage-product-add-button thq-button-filled button" />
