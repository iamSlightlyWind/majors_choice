                    ...
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Add New Product - New Product Case&nbsp;
                            </span>
                        </div>
                    </div>
                            ...
                            <form action="/cases?service=insertCase" method="post" enctype="multipart/form-data">
                                ...
                                <div class="manage-product-add-form04">
                                    ...
                                    <div class="manage-product-add-container03">
                                        <input type="text" placeholder="Text" name="formFactor" class="manage-product-add-textinput04 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form05">
                                    ...
                                    <div class="manage-product-add-container04">
                                        <input type="number" placeholder="Text" name="color" class="manage-product-add-textinput05 input" />
                                    </div>
                                </div>
                                ...
                                <div class="manage-product-add-container13">
                                    <input type="submit" name="submit" value="Add Case" class="manage-product-add-button thq-button-filled button" />
