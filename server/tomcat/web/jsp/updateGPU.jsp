                            ...
                            <div class="manage-product-add-root-form">
                                ...
                                <form action="/gpus" method="post" enctype="multipart/form-data">
                                    <div class="manage-product-add-form">
                                        ...
                                        <input type="number" name="sellingPrice" value="<%=gpu.getSellingPrice()%>" class="manage-product-add-textinput input" />
                                    </div>
                                    <div class="manage-product-add-form01">
                                        <span class="manage-product-add-text07">Cost Price</span>
                                        <input type="number" name="costPrice" value="<%=gpu.getCostPrice()%>" class="manage-product-add-textinput01 input" />
                                    </div>
                                    ...
                                    <div class="manage-product-add-form03">
                                        ...
                                        <div class="manage-product-add-container02">
                                            <input type="text" name="name" value="<%=gpu.getName()%>" class="manage-product-add-textinput03 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form05">
                                        ...
                                        <div class="manage-product-add-container04">
                                            <input type="text" name="generation" value="<%=gpu.getGeneration()%>" class="manage-product-add-textinput05 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form06">
                                        ...
                                        <div class="manage-product-add-container05">
                                            <input type="number" name="vram" value="<%=gpu.getVram()%>" class="manage-product-add-textinput06 input" />
                                        </div>
                                    </div>                                    
                                    <div class="manage-product-add-form09">
                                        ...
                                        <div class="manage-product-add-container08">
                                            <input type="number" name="baseClock" value="<%=gpu.getBaseClock()%>" class="manage-product-add-textinput09 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form10">
                                        ...
                                        <div class="manage-product-add-container09">
                                            <input type="number" name="boostClock" value="<%=gpu.getBoostClock()%>" class="manage-product-add-textinput10 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form11">
                                        ...
                                        <div class="manage-product-add-container10">
                                            <input type="number" name="tdp" value="<%=gpu.getTdp()%>" class="manage-product-add-textinput11 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form12">
                                        ...
                                        <div class="manage-product-add-container11">
                                            <input type="number" name="quantity" value="<%=gpu.getQuantity()%>" class="manage-product-add-textinput12 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-container13">
                                        <input type="submit" name="submit" value="Update GPU" class="manage-product-add-button thq-button-filled button" />
