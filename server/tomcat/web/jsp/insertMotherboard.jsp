...
<%@page import="java.util.Vector,packages.Motherboard"%>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="manage-product-add-container">
                ...
                <div class="manage-product-add-body">
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Add New Product - New Product Motherboard&nbsp;
                            </span>
                        </div>
                    </div>
                    <div class="manage-product-add-root">
                        <div
                            class="menu-add-product-menu-add-product menu-add-product-root-class-name5"
                            >
                        ...
                        <div class="manage-product-add-root-form">
                            ...
                            <form action="/motherboards?service=insertMotherboard" method="post" enctype="multipart/form-data">
                                <div class="manage-product-add-form">
                                    ...
                                    <input type="number" placeholder="Number" name="sellingPrice" class="manage-product-add-textinput input" />
                                </div>
                                <div class="manage-product-add-form01">
                                    <span class="manage-product-add-text07">Cost Price</span>
                                    <input type="number" placeholder="Number" name="costPrice" class="manage-product-add-textinput01 input" />
                                </div>
                                ...
                                <div class="manage-product-add-form04">
                                    ...
                                    <div class="manage-product-add-container03">
                                        <input type="text" placeholder="Text" name="socket" class="manage-product-add-textinput04 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form05">
                                    ...
                                    <div class="manage-product-add-container04">
                                        <input type="text" placeholder="Text" name="chipset" class="manage-product-add-textinput05 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form06">
                                    ...
                                    <div class="manage-product-add-container05">
                                        <input type="number" placeholder="Number" name="igpu" class="manage-product-add-textinput06 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form07">
                                    ...
                                    <div class="manage-product-add-container06">
                                        <input type="text" placeholder="Text" name="formFactor" class="manage-product-add-textinput07 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form08">
                                    ...
                                    <div class="manage-product-add-container07">
                                        <input type="text" placeholder="Text" name="ramType" class="manage-product-add-textinput08 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form09">
                                    ...
                                    <div class="manage-product-add-container08">
                                        <input type="number" placeholder="Number" name="maxRamSpeed" class="manage-product-add-textinput09 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form10">
                                    ...
                                    <div class="manage-product-add-container09">
                                        <input type="number" placeholder="Number" name="maxRamCapacity" class="manage-product-add-textinput10 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form11">
                                    ...
                                    <div class="manage-product-add-container10">
                                        <input type="number" placeholder="Number" name="ramSlots" class="manage-product-add-textinput11 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form11">
                                    <span class="manage-product-add-text35">
                                    ...
                                    <div class="manage-product-add-container10">
                                        <input type="number" placeholder="Number" name="wifi" class="manage-product-add-textinput11 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form12">
                                    ...
                                    <div class="manage-product-add-container11">
                                        <input type="number" placeholder="Number" name="quantity" class="manage-product-add-textinput12 input" />
                                    </div>
                                </div>
                    ...
                    <div class="manage-product-add-footer">
                        <footer
                            class="footer-footer1 thq-section-padding footer-root-class-name12"
                            >
