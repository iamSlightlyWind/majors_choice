...
<html lang="en">
    ...
    <head>
        ...
        <meta property="og:title" content="ManageListProductGPU - Major's Choice1" />
    ...
    <body>
        ...
        <div>
            ...
            <div class="manage-list-product-gpu-container">
                        ...
                        <div class="manage-list-product-gpu-table">
                            ...
                            <div class="manage-list-product-gpu-list-catevs-search">
                                    ...
                                    <div data-thq="thq-dropdown"
                                        ...
                                        <div data-thq="thq-dropdown-toggle"
                                            ...
                                            <div data-thq="thq-dropdown-arrow"
                                                ...
                                                <svg viewBox="0 0 1024 1024" class="manage-list-product-gpu-icon">
                                ...
                                <a href="/jsp/insertGPU.jsp">
                                    <div class="manage-list-product-gpu-add-product thq-button-filled">
                                        <svg viewBox="0 0 1024 1024" class="manage-list-product-gpu-icon2">
                                        <path
                                ...
                                <body>
                                    <form id="importExcelForm" action="gpus?service=importExcel" method="post"
                                ...
                                <form action="gpus" method="post" class="manage-list-product-gpu-search-product">
                                    <input type="text" name="searchName" value="${requestScope.searchName}" class="manage-list-product-gpu-textinput input" />
                                    <button class="manage-list-product-gpu-search thq-button-filled" type="submit" value="Search" >
                            ...
                            <div class="manage-list-product-gpu-list-detail">
                                ...
                                <form class="manage-list-product-gpu-form-product1">
                                    ...
                                    <div class="manage-list-product-gpu-image1">
                                        <img alt="image" src="images/<%= gpu.getId() %>.png"
                                    ...
                                    <div class="manage-list-product-gpu-cost-price1">
                                        <span class="manage-list-product-gpu-text94">
                                            <%= costPrice %>đ
                                        </span>
                                    </div>
                                    ...
                                    <div class="manage-list-product-gpu-update">
                                        <a href="gpus?service=update&id=<%= gpu.getId() %>">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-gpu-icon4 thq-button-icon">
                                            <path
                ...
                <footer class="footer-footer1 thq-section-padding footer-root-class-name56">
