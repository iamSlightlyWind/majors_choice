                            ...
                            <div class="manage-product-add-root-form">
                                ...
                                <form action="/psus" method="post" enctype="multipart/form-data">
                                    <div class="manage-product-add-form">
                                        ...
                                        <input type="number" name="sellingPrice" value="<%=psu.getSellingPrice()%>" class="manage-product-add-textinput input" />
                                    </div>
                                    <div class="manage-product-add-form01">
                                        <span class="manage-product-add-text07">Cost Price</span>
                                        <input type="number" name="costPrice" value="<%=psu.getCostPrice()%>" class="manage-product-add-textinput01 input" />
                                    </div>
                                    <div class="manage-product-add-form02">
                                        ...
                                        <input type="file" name="image" accept="image/*" value="<%=psu.getImage()%>" class="manage-product-add-textinput02 input" />
                                    </div>
                                    <div class="manage-product-add-form03">
                                        ...
                                        <div class="manage-product-add-container02">
                                            <input type="text" name="name" value="<%=psu.getName()%>" class="manage-product-add-textinput03 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form04">
                                        ...
                                        <div class="manage-product-add-container03">
                                            <input type="number" name="wattage" value="<%=psu.getWattage()%>" class="manage-product-add-textinput04 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form05">
                                        ...
                                        <div class="manage-product-add-container04">
                                            <input type="text" name="efficiency" value="<%=psu.getEfficiency()%>" class="manage-product-add-textinput05 input" />
                                        </div>
                                    </div>                                  
                                    <div class="manage-product-add-form12">
                                        ...
                                        <div class="manage-product-add-container11">
                                            <input type="number" name="quantity" value="<%=psu.getQuantity()%>" class="manage-product-add-textinput12 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-container13">
                                        <input type="submit" name="submit" value="Update PSU" class="manage-product-add-button thq-button-filled button" />
