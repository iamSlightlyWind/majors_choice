...
<%@page import="java.util.Vector,packages.GPU"%>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Add New Product - New Product GPU&nbsp;
                            </span>
                        </div>
                    </div>
                            ...
                            <form action="/gpus?service=insertGPU" method="post" enctype="multipart/form-data">
                                ...
                                <div class="manage-product-add-form07">
                                    ...
                                    <div class="manage-product-add-container06">
                                        <input type="number" placeholder="Number" name="vram" class="manage-product-add-textinput07 input" />
                                    </div>
                                </div>
                                ...
                                <div class="manage-product-add-container13">
                                    <input type="submit" name="submit" value="Add GPU" class="manage-product-add-button thq-button-filled button" />
