...
<%@page import="java.util.Vector,packages.RAM"%>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="manage-product-add-body">
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Add New Product - New Product RAM&nbsp;
                            </span>
                        </div>
                    </div>
                    <div class="manage-product-add-root">
                        ...
                        <div class="manage-product-add-root-form">
                            ...
                            <form action="/rams?service=insertRAM" method="post" enctype="multipart/form-data">
                                ...
                                <div class="manage-product-add-form04">
                                    ...
                                    <div class="manage-product-add-container03">
                                        <input type="text" placeholder="Text" name="generation" class="manage-product-add-textinput04 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form05">
                                    ...
                                    <div class="manage-product-add-container04">
                                        <input type="number" placeholder="Number" name="capacity" class="manage-product-add-textinput05 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form06">
                                    ...
                                    <div class="manage-product-add-container05">
                                        <input type="number" placeholder="Number" name="speed" class="manage-product-add-textinput06 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form07">
                                    ...
                                    <div class="manage-product-add-container06">
                                        <input type="number" placeholder="Number" name="latency" class="manage-product-add-textinput07 input" />
                                    </div>
                                </div>
                                ...
                                <div class="manage-product-add-container13">
                                    <input type="submit" name="submit" value="Add RAM" class="manage-product-add-button thq-button-filled button" />
