                            ...
                            <div class="manage-product-add-root-form">
                                ...
                                <form action="/cpus" method="post" enctype="multipart/form-data">
                                    <div class="manage-product-add-form">
                                        ...
                                        <input type="number" name="sellingPrice" value="<%=cpu.getSellingPrice()%>" class="manage-product-add-textinput input" />
                                    </div>
                                    <div class="manage-product-add-form01">
                                        <span class="manage-product-add-text07">Cost Price</span>
                                        <input type="number" name="costPrice" value="<%=cpu.getCostPrice()%>" class="manage-product-add-textinput01 input" />
                                    </div>
                                    <div class="manage-product-add-form02">
                                        ...
                                        <input type="file" name="image" accept="image/*" value="<%=cpu.getImage()%>" class="manage-product-add-textinput02 input" />
                                    </div>
                                    <div class="manage-product-add-form03">
                                        ...
                                        <div class="manage-product-add-container02">
                                            <input type="text" name="name" value="<%=cpu.getName()%>" class="manage-product-add-textinput03 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form04">
                                        ...
                                        <div class="manage-product-add-container03">
                                            <input type="text" name="igpu" value="<%=cpu.getIgpu()%>" class="manage-product-add-textinput04 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form05">
                                        ...
                                        <div class="manage-product-add-container04">
                                            <input type="text" name="generation" value="<%=cpu.getGeneration()%>" class="manage-product-add-textinput05 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form06">
                                        ...
                                        <div class="manage-product-add-container05">
                                            <input type="text" name="socket" value="<%=cpu.getSocket()%>" class="manage-product-add-textinput06 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form07">
                                        ...
                                        <div class="manage-product-add-container06">
                                            <input type="number" name="cores" value="<%=cpu.getCores()%>" class="manage-product-add-textinput07 input" />
                                        </div>
                                    </div>
