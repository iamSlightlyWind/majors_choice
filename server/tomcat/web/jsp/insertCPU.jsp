                    ...
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Add New Product - New Product CPU&nbsp;
                            </span>
                        </div>
                    </div>
                            ...
                            <form action="/cpus?service=insertCPU" method="post" enctype="multipart/form-data">
                                ...
                                <div class="manage-product-add-form06">
                                    ...
                                    <div class="manage-product-add-container05">
                                        <input type="text" placeholder="Socket" name="socket" class="manage-product-add-textinput06 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form07">
                                    ...
                                    <div class="manage-product-add-container06">
                                        <input type="number" placeholder="Number" name="cores" class="manage-product-add-textinput07 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form08">
                                    ...
                                    <div class="manage-product-add-container07">
                                        <input type="number" placeholder="Number" name="threads" class="manage-product-add-textinput08 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form09">
                                    ...
                                    <div class="manage-product-add-container08">
                                        <input type="number" placeholder="Number" name="baseClock" class="manage-product-add-textinput09 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form10">
                                    ...
                                    <div class="manage-product-add-container09">
                                        <input type="number" placeholder="Number" name="boostClock" class="manage-product-add-textinput10 input" />
                                    </div>
                                </div>
                                <div class="manage-product-add-form11">
                                    ...
                                    <div class="manage-product-add-container10">
                                        <input type="number" placeholder="Number" name="tdp" class="manage-product-add-textinput11 input" />
                                    </div>
                                </div>
                                ...
                                <div class="manage-product-add-container13">
                                    <input type="submit" name="submit" value="Add CPU" class="manage-product-add-button thq-button-filled button" />
