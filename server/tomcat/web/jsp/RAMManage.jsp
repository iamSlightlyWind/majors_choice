...
<html lang="en">
    <head>
        ...
        <meta
            property="og:title"
            content="ManageListProductRAM - Major's Choice1"
            />
                        ...
                        <div class="manage-list-product-ram-table">
                            ...
                            <div class="manage-list-product-ram-list-catevs-search">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <svg
                                                    viewBox="0 0 1024 1024"
                                                    class="manage-list-product-ram-icon"
                                                    >
                                ...
                                <div class="manage-list-product-ram-search-product">
                                    <input
                                        type="text"
                                        class="manage-list-product-ram-textinput input"
                                        />
                                    <button
                                        class="manage-list-product-ram-search thq-button-filled"
                                        >
    ...
    String sellingPrice = String.format(Locale.US, "%,.0f", ram.getSellingPrice());
                                ...
                                <form class="manage-list-product-ram-form-product1">
                                    ...
                                    <div class="manage-list-product-ram-cost-price1">
                                        <span class="manage-list-product-ram-text88"><%= costPrice %>đ</span>
                                    </div>
                                    <div class="manage-list-product-ram-quanity1">
                                        <span class="manage-list-product-ram-text89">
                                            <span><%= ram.getQuantity() %></span>
                                            <br />
                                        </span>
                                    </div>
                ...
                <footer
                    class="footer-footer1 thq-section-padding footer-root-class-name59"
                    >
