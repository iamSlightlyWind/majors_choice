<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@page import="java.util.ArrayList,packages.RAM,java.util.Locale" %>
        ...
        <head>
            <title>ManageListProductRAM - Major's Choice1</title>
            <meta property="og:title" content="ManageListProductRAM - Major's Choice1" />
        ...
        <body>
            ...
            <div>
                <link href="../css/manage-product-ram.css" rel="stylesheet" />

                <div class="manage-list-product-ram-container">
                    <div class="manage-list-product-ram-header">
                        <div class="navmain-container navmain-root-class-name58">
                    ...
                    <div class="manage-list-product-ram-body">
                        <div class="manage-list-product-ram-link-page">
                            <span class="manage-list-product-ram-text thq-body-small thq-link">
                                Home&nbsp;
                            </span>
                            <span class="manage-list-product-ram-text01">
                                / Manager Warehouse
                            </span>
                        </div>
                        <div class="manage-list-product-ram-root-form">
                            <div class="manage-list-product-ram-table">
                                <h1 class="manage-list-product-ram-text02">Manage RAM</h1>
                                <div class="manage-list-product-ram-list-catevs-search">
                                    <div class="manage-list-product-ram-list-category">
                                        <div data-thq="thq-dropdown"
                                            class="manage-list-product-ram-thq-dropdown list-item">
                                            <div data-thq="thq-dropdown-toggle"
                                                class="manage-list-product-ram-dropdown-toggle">
                                                <span class="manage-list-product-ram-text03">
                                                    <span>List Category</span>
                                                    <br />
                                                </span>
                                                <div data-thq="thq-dropdown-arrow"
                                                    class="manage-list-product-ram-dropdown-arrow">
                                                    <svg viewBox="0 0 1024 1024" class="manage-list-product-ram-icon">
                                                        <path d="M426 726v-428l214 214z"></path>
                                                    </svg>
                                                </div>
                                            </div>
                                            <ul data-thq="thq-dropdown-list"
                                                class="manage-list-product-ram-dropdown-list">
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown list-item">
                                                    <a href="/cpus">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle1">
                                                            <span class="manage-list-product-ram-text06">
                                                ...
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown1 list-item">
                                                    <a href="/gpus">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle2">
                                                            <span class="manage-list-product-ram-text09">
                                                ...
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown2 list-item">
                                                    <a href="/motherboards">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle3">
                                                            <span class="manage-list-product-ram-text12">
                                                ...
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown3 list-item">
                                                    <a href="/psus">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle4">
                                                            <span class="manage-list-product-ram-text15">
                                                ...
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown4 list-item">
                                                    <a href="/rams">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle5">
                                                            <span class="manage-list-product-ram-text18">
                                                ...
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown5 list-item">
                                                    <a href="/ssds">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle6">
                                                            <span class="manage-list-product-ram-text21">
                                                ...
                                                <li data-thq="thq-dropdown"
                                                    class="manage-list-product-ram-dropdown6 list-item">
                                                    <a href="/cases">
                                                        <div data-thq="thq-dropdown-toggle"
                                                            class="manage-list-product-ram-dropdown-toggle7">
                                                            <span class="manage-list-product-ram-text24">
                                    ...
                                    <a href="/jsp/insertRAM.jsp">
                                        <div class="manage-list-product-ram-add-product thq-button-filled">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-ram-icon2">
                                                <path
                                    ...
                                    <body>
                                        <form id="importExcelForm" action="rams?service=importExcel" method="post"
                                ...
                                <div class="manage-list-product-ram-list-detail">
                                    <form class="manage-list-product-ram-form-tittle">
                                        <div class="manage-list-product-ram-id">
                                            <span class="manage-list-product-ram-text37">
                                                <span>ID</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-image">
                                            <span class="manage-list-product-ram-text40">
                                                <span>Image</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-name">
                                            <span class="manage-list-product-ram-text43">
                                                <span>Name</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-genernation">
                                            <span class="manage-list-product-ram-text46">
                                                <span>Genernation</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-soccet">
                                            <span class="manage-list-product-ram-text49">
                                                <span>Capacity</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-c-t">
                                            <span class="manage-list-product-ram-text52">
                                                <span>Speed</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-clock">
                                            <span class="manage-list-product-ram-text55">
                                                <span>Latency</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-selling-price">
                                            <span class="manage-list-product-ram-text58">
                                                <span>Selling Price</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-cost-price">
                                            <span class="manage-list-product-ram-text61">
                                                <span>Cost Price</span>
                                                <br />
                                            </span>
                                        </div>
                                        <div class="manage-list-product-ram-quanity">
                                            <span class="manage-list-product-ram-text64">
                                                <span>Quanity</span>
                                                <br />
                                            </span>
                                        </div>
                                    ...
                                    <% ArrayList<RAM> rams = (ArrayList<RAM>) request.getAttribute("rams");
                                            ...
                                            ram.getSellingPrice());
                                            %>
                                            <form class="manage-list-product-ram-form-product1">
                                                <div class="manage-list-product-ram-id1">
                                                    <span class="manage-list-product-ram-text67">
                                                        <span>
                                                            <%= ram.getId() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-image1">
                                                    <img alt="image" src="images/<%= ram.getId() %>.png"
                                                        class="manage-list-product-ram-image2" />
                                                </div>
                                                <div class="manage-list-product-ram-name1">
                                                    <span class="manage-list-product-ram-text70">
                                                        <span>
                                                            <%= ram.getName() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-genernation1">
                                                    <span class="manage-list-product-ram-text73">
                                                        <span>
                                                            <%= ram.getGeneration() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-capacity">
                                                    <span class="manage-list-product-ram-text76">
                                                        <span>
                                                            <%= ram.getCapacity() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-speed">
                                                    <span class="manage-list-product-ram-text79">
                                                        <span>
                                                            <%= ram.getSpeed() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-latency">
                                                    <span class="manage-list-product-ram-text82">
                                                        <span>
                                                            <%= ram.getLatency() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-selling-price1">
                                                    <span class="manage-list-product-ram-text85">
                                                        <span>
                                                            <%= sellingPrice %>đ
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-cost-price1">
                                                    <span class="manage-list-product-ram-text88">
                                                        <%= costPrice %>đ
                                                    </span>
                                                </div>
                                                <div class="manage-list-product-ram-quanity1">
                                                    <span class="manage-list-product-ram-text89">
                                                        <span>
                                                            <%= ram.getQuantity() %>
                                                        </span>
                                                        <br />
                                                ...
                                                <div class="manage-list-product-ram-update">
                                                    ...
                                                    <a href="#"  onclick="confirmDelete('rams?service=delete&id=<%= ram.getId() %>');">
                                                        <svg viewBox="0 0 1024 1024"
                    ...
                    <footer class="footer-footer1 thq-section-padding footer-root-class-name59">
