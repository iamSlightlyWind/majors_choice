...
<html lang="en">
    <head>
        ...
        <meta
            property="og:title"
            content="ManageListProductSSD - Major's Choice1"
            />
                        ...
                        <div class="manage-list-product-ssd-table">
                            ...
                            <div class="manage-list-product-ssd-list-catevs-search">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <svg
                                                    viewBox="0 0 1024 1024"
                                                    class="manage-list-product-ssd-icon"
                                                    >
                                ...
                                <div class="manage-list-product-ssd-search-product">
                                    <input
                                        type="text"
                                        class="manage-list-product-ssd-textinput input"
                                        />
                                    <button
                                        class="manage-list-product-ssd-search thq-button-filled"
                                        >
    ...
    String sellingPrice = String.format(Locale.US, "%,.0f", ssd.getSellingPrice());
                                ...
                                <form class="manage-list-product-ssd-form-product1">
                                    ...
                                    <div class="manage-list-product-ssd-update">
                                        ...
                                        <a href="ssds?service=delete&id=<%= ssd.getId() %>">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-ssd-icon6 thq-button-icon">
                ...
                <footer
                    class="footer-footer1 thq-section-padding footer-root-class-name58"
                    >
