...
<html lang="en">
    ...
    <head>
        <title>ManageListProductSSD - Major's Choice1</title>
        <meta property="og:title" content="ManageListProductSSD - Major's Choice1" />
    ...
    <body>
        ...
        <div>
            <link href="../css/manage-product-ssd.css" rel="stylesheet" />

            <div class="manage-list-product-ssd-container">
                <div class="manage-list-product-ssd-header">
                    <div class="navmain-container navmain-root-class-name57">
                ...
                <div class="manage-list-product-ssd-body">
                    <div class="manage-list-product-ssd-link-page">
                        <span class="manage-list-product-ssd-text thq-body-small thq-link">
                            Home&nbsp;
                        </span>
                    ...
                    <div class="manage-list-product-ssd-root-form">
                        <div class="manage-list-product-ssd-table">
                            <h1 class="manage-list-product-ssd-text02">Manage SSD</h1>
                            <div class="manage-list-product-ssd-list-catevs-search">
                                <div class="manage-list-product-ssd-list-category">
                                    <div data-thq="thq-dropdown"
                                         class="manage-list-product-ssd-thq-dropdown list-item">
                                        <div data-thq="thq-dropdown-toggle"
                                             class="manage-list-product-ssd-dropdown-toggle">
                                            <span class="manage-list-product-ssd-text03">
                                                <span>List Category</span>
                                                <br />
                                            </span>
                                            <div data-thq="thq-dropdown-arrow"
                                                 class="manage-list-product-ssd-dropdown-arrow">
                                                <svg viewBox="0 0 1024 1024" class="manage-list-product-ssd-icon">
                                                <path d="M426 726v-428l214 214z"></path>
                                                </svg>
                                            </div>
                                        </div>
                                        <ul data-thq="thq-dropdown-list"
                                            class="manage-list-product-ssd-dropdown-list">
                                            <li data-thq="thq-dropdown"
                                                class="manage-list-product-ssd-dropdown list-item">
                                                <a href="/cpus">
                                                    <div data-thq="thq-dropdown-toggle"
                                                         class="manage-list-product-ssd-dropdown-toggle1">
                                                        <span class="manage-list-product-ssd-text06">
                                            ...
                                            <li data-thq="thq-dropdown"
                                                class="manage-list-product-ssd-dropdown1 list-item">
                                                <a href="/gpus">
                                                    <div data-thq="thq-dropdown-toggle"
                                                         class="manage-list-product-ssd-dropdown-toggle2">
                                                        <span class="manage-list-product-ssd-text09">
                                            ...
                                            <li data-thq="thq-dropdown"
                                                class="manage-list-product-ssd-dropdown2 list-item">
                                                <a href="/motherboards">
                                                    <div data-thq="thq-dropdown-toggle"
                                                         class="manage-list-product-ssd-dropdown-toggle3">
                                                        <span class="manage-list-product-ssd-text12">
                                            ...
                                            <li data-thq="thq-dropdown"
                                                class="manage-list-product-ssd-dropdown3 list-item">
                                                <a href="/psus">
                                                    <div data-thq="thq-dropdown-toggle"
                                                         class="manage-list-product-ssd-dropdown-toggle4">
                                                        <span class="manage-list-product-ssd-text15">
                                            ...
                                            <li data-thq="thq-dropdown"
                                                class="manage-list-product-ssd-dropdown4 list-item">
                                                <a href="/rams">
                                                    <div data-thq="thq-dropdown-toggle"
                                                         class="manage-list-product-ssd-dropdown-toggle5">
                                                        <span class="manage-list-product-ssd-text18">
                                ...
                                <a href="/jsp/insertSSD.jsp">
                                    <div class="manage-list-product-ssd-add-product thq-button-filled">
                                        <svg viewBox="0 0 1024 1024" class="manage-list-product-ssd-icon2">
                                        <path
                                ...
                                <body>
                                    <form id="importExcelForm" action="cpus?service=importExcel" method="post"
                                ...
                                <form action="ssds" method="post" class="manage-list-product-ssd-search-product">                   
                                    <input type="text" name="searchName" value="${requestScope.searchName}" class="manage-list-product-ssd-textinput input" />
                                    <button class="manage-list-product-ssd-search thq-button-filled" type="submit" value="Search">
                                        <span class="manage-list-product-ssd-text34 thq-body-small">
                                            <span>Search</span>
                                            <br />
                                        </span>
                                    </button>
                            ...
                            <div class="manage-list-product-ssd-list-detail">
                                <form class="manage-list-product-ssd-form-tittle">
                                    <div class="manage-list-product-ssd-id">
                                        <span class="manage-list-product-ssd-text37">
                                            <span>ID</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-image">
                                        <span class="manage-list-product-ssd-text40">
                                            <span>Image</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-name">
                                        <span class="manage-list-product-ssd-text43">
                                            <span>Name</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-interface">
                                        <span class="manage-list-product-ssd-text46">
                                            <span>Interface</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-capacity">
                                        <span class="manage-list-product-ssd-text49">
                                            <span>Capacity</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-cache">
                                        <span class="manage-list-product-ssd-text52">
                                            <span>Cache</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-selling-price">
                                        <span class="manage-list-product-ssd-text55">
                                            <span>Selling Price</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-cost-price">
                                        <span class="manage-list-product-ssd-text58">
                                            <span>Cost Price</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-quanity">
                                        <span class="manage-list-product-ssd-text61">
                                            <span>Quanity</span>
                                            <br />
                                        </span>
                                    </div>
                                ...
                                <% ArrayList<SSD> ssds = (ArrayList<SSD>) request.getAttribute("ssds");
                                        ...
                                        ssd.getSellingPrice());
                                %>
                                <form class="manage-list-product-ssd-form-product1">
                                    <div class="manage-list-product-ssd-id1">
                                        <span class="manage-list-product-ssd-text64">
                                            <span>
                                                <%= ssd.getId() %>
                                            </span>
                                            <br />
                                    ...
                                    <div class="manage-list-product-ssd-image1">
                                        <img alt="image" src="images/<%= ssd.getId() %>.png"
                                             class="manage-list-product-ssd-image2" />
                                    </div>
                                    <div class="manage-list-product-ssd-name1">
                                        <span class="manage-list-product-ssd-text67">
                                            <span>
                                                <%= ssd.getName() %>
                                            </span>
                                            <br />
                                    ...
                                    <div class="manage-list-product-ssd-interface1">
                                        <span class="manage-list-product-ssd-text70">
                                            <%= ssd.getConnectionInterface() %>
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-capacity1">
                                        <span class="manage-list-product-ssd-text71">
                                            <span>
                                                <%= ssd.getCapacity() %>
                                            </span>
                                            <br />
                                    ...
                                    <div class="manage-list-product-ssd-cache1">
                                        <span class="manage-list-product-ssd-text74">
                                            <span>
                                                <%= ssd.getCache() %>
                                            </span>
                                            <br />
                                    ...
                                    <div class="manage-list-product-ssd-selling-price1">
                                        <span class="manage-list-product-ssd-text77">
                                            <span>
                                                <%= sellingPrice %>đ
                                            </span>
                                            <br />
                                    ...
                                    <div class="manage-list-product-ssd-cost-price1">
                                        <span class="manage-list-product-ssd-text80">
                                            <%= costPrice %>đ
                                        </span>
                                    </div>
                                    <div class="manage-list-product-ssd-quanity1">
                                        <span class="manage-list-product-ssd-text81">
                                            <span>
                                                <%= ssd.getQuantity() %>
                                            </span>
                                            <br />
                                    ...
                                    <div class="manage-list-product-ssd-update">
                                        <a href="ssds?service=update&id=<%= ssd.getId() %>">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-ssd-icon4 thq-button-icon">
                                            <path
                                        ...
                                        <a href="#"  onclick="confirmDelete('ssds?service=delete&id=<%= ssd.getId() %>');">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-ssd-icon6 thq-button-icon">
                                            <path
                ...
                <footer class="footer-footer1 thq-section-padding footer-root-class-name58">
