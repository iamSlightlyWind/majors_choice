                    ...
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Update Product - Update Product CPU&nbsp;
                            </span>
                        </div>
                    </div>
                            ...
                            <div class="manage-product-add-root-form">
                                ...
                                <form action="/rams" method="post" enctype="multipart/form-data">
                                    <div class="manage-product-add-form">
                                        ...
                                        <input type="number" name="sellingPrice" value="<%=ram.getSellingPrice()%>" class="manage-product-add-textinput input" />
                                    </div>
                                    <div class="manage-product-add-form01">
                                        <span class="manage-product-add-text07">Cost Price</span>
                                        <input type="number" name="costPrice" value="<%=ram.getCostPrice()%>" class="manage-product-add-textinput01 input" />
                                    </div>
                                    <div class="manage-product-add-form02">
                                        ...
                                        <input type="file" name="image" accept="image/*" value="<%=ram.getImage()%>" class="manage-product-add-textinput02 input" />
                                    </div>
                                    <div class="manage-product-add-form03">
                                        ...
                                        <div class="manage-product-add-container02">
                                            <input type="text" name="name" value="<%=ram.getName()%>" class="manage-product-add-textinput03 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form04">
                                        ...
                                        <div class="manage-product-add-container03">
                                            <input type="text" name="generation" value="<%=ram.getGeneration()%>" class="manage-product-add-textinput04 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form05">
                                        ...
                                        <div class="manage-product-add-container04">
                                            <input type="number" name="capacity" value="<%=ram.getCapacity()%>" class="manage-product-add-textinput05 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form06">
                                        ...
                                        <div class="manage-product-add-container05">
                                            <input type="number" name="speed" value="<%=ram.getSpeed()%>" class="manage-product-add-textinput06 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form07">
                                        ...
                                        <div class="manage-product-add-container06">
                                            <input type="number" name="latency" value="<%=ram.getLatency()%>" class="manage-product-add-textinput07 input" />
                                        </div>
                                    </div>                                   
                                    <div class="manage-product-add-form12">
                                        ...
                                        <div class="manage-product-add-container11">
                                            <input type="number" name="quantity" value="<%=ram.getQuantity()%>" class="manage-product-add-textinput12 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-container13">
                                        <input type="submit" name="submit" value="Update RAM" class="manage-product-add-button thq-button-filled button" />
