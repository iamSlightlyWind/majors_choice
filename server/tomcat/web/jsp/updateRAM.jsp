                                    ...
                                    <div class="manage-product-add-root-form">
                                        ...
                                        <form action="/rams" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="manage-product-add-form01">
                                                ...
                                                <input type="number" name="costPrice" value="<%=ram.getCostPrice()%>"
                                            ...
                                            <div class="manage-product-add-form03">
                                                ...
                                                <div class="manage-product-add-container02">
                                                    <input type="text" name="name" value="<%=ram.getName()%>"
                                            ...
                                            <div class="manage-product-add-form05">
                                                ...
                                                <div class="manage-product-add-container04">
                                                    <input type="number" name="capacity" value="<%=ram.getCapacity()%>"
                                            ...
                                            <div class="manage-product-add-form07">
                                                ...
                                                <div class="manage-product-add-container06">
                                                    <input type="number" name="latency" value="<%=ram.getLatency()%>"
                                            ...
                                            <div class="manage-product-add-form12">
                                                ...
                                                <div class="manage-product-add-container11">
                                                    <input type="number" name="quantity" value="<%=ram.getQuantity()%>"
                                                        class="manage-product-add-textinput12 input" />
                                                </div>
                                            </div>
                                            <div class="manage-product-add-container13">
                                                <input type="submit" name="submit" value="Update RAM"
