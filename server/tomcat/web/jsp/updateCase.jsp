...
<%@page import="java.util.ArrayList,packages.Case"%>
<%
                    ...
                    <div class="manage-product-add-link-page">
                        <div class="manage-product-add-container01">
                            ...
                            <span class="manage-product-add-text02 thq-body-small">
                                &nbsp;/ Update Product - Update Product Case&nbsp;
                            </span>
                        </div>
                    </div>
                            ...
                            <div class="manage-product-add-root-form">
                                ...
                                <form action="/cases" method="post" enctype="multipart/form-data">
                                    <div class="manage-product-add-form">
                                        ...
                                        <input type="number" name="sellingPrice" value="<%=caseItem.getSellingPrice()%>" class="manage-product-add-textinput input" />
                                    </div>
                                    <div class="manage-product-add-form01">
                                        <span class="manage-product-add-text07">Cost Price</span>
                                        <input type="number" name="costPrice" value="<%=caseItem.getCostPrice()%>" class="manage-product-add-textinput01 input" />
                                    </div>
                                    <div class="manage-product-add-form02">
                                        ...
                                        <input type="file" name="image" accept="image/*" value="<%=caseItem.getImage()%>" class="manage-product-add-textinput02 input" />
                                    </div>
                                    <div class="manage-product-add-form03">
                                        ...
                                        <div class="manage-product-add-container02">
                                            <input type="text" name="name" value="<%=caseItem.getName()%>" class="manage-product-add-textinput03 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form04">
                                        ...
                                        <div class="manage-product-add-container03">
                                            <input type="text" name="formFactor" value="<%=caseItem.getFormFactor()%>" class="manage-product-add-textinput04 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form05">
                                        ...
                                        <div class="manage-product-add-container04">
                                            <input type="text" name="color" value="<%=caseItem.getColor()%>" class="manage-product-add-textinput05 input" />
                                        </div>
                                    </div>                                  
                                    <div class="manage-product-add-form12">
                                        ...
                                        <div class="manage-product-add-container11">
                                            <input type="number" name="quantity" value="<%=caseItem.getQuantity()%>" class="manage-product-add-textinput12 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-container13">
                                        <input type="submit" name="submit" value="Update Case" class="manage-product-add-button thq-button-filled button" />
