    ...
    <body>
        ...
        <div>
            ...
            <div class="manage-list-product-container">
                        ...
                        <div class="manage-list-product-table">
                            ...
                            <div class="manage-list-product-list-catevs-search">
                                <div class="manage-list-product-list-category">
                                    <div data-thq="thq-dropdown" class="manage-list-product-thq-dropdown list-item">
                                        <div data-thq="thq-dropdown-toggle"
                                            ...
                                            <div data-thq="thq-dropdown-arrow"
                                                ...
                                                <svg viewBox="0 0 1024 1024" class="manage-list-product-icon">
                                                <path d="M426 726v-428l214 214z"></path>
                                                </svg>
                                            </div>
                                        </div>
                                        <ul data-thq="thq-dropdown-list" class="manage-list-product-dropdown-list">
                                ...
                                <a href="/jsp/insertCPU.jsp">
                                    <div class="manage-list-product-add-product thq-button-filled">
                                        <svg viewBox="0 0 1024 1024" class="manage-list-product-icon2">
                                        <path
                            ...
                            <div class="manage-list-product-list-detail">
                                ...
                                <form class="manage-list-product-form-product1">
                                    ...
                                    <div class="manage-list-product-image1">
                                        <img alt="image" src="images/<%= cpu.getId() %>.png"
                                             class="manage-list-product-image2" />
                                    </div>
                                    ...
                                    <div class="manage-list-product-clock1">
                                        <span class="manage-list-product-text087">
                                            <span>
                                                <%= cpu.getBaseClock() %> - <%= cpu.getBoostClock() %>
                                            </span>
                                            <br />
                                        </span>
                                    </div>
                                    ...
                                    <div class="manage-list-product-cost-price1">
                                        <span class="manage-list-product-text096">
                                            <%= costPrice %>đ
                                        </span>
                                    </div>
                                    ...
                                    <div class="manage-list-product-update">
                                        <a href="cpus?service=update&id=<%= cpu.getId() %>">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-icon4 thq-button-icon">
                                            <path
                                        ...
                                        <a href="#"  onclick="confirmDelete('cpus?service=delete&id=<%= cpu.getId() %>');">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-icon6 thq-button-icon">
                                            <path
                ...
                <footer class="footer-footer1 thq-section-padding footer-root-class-name34">
