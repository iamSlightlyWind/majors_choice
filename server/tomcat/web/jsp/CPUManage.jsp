...
<html lang="en">
    <head>
        <title>ManageListProduct - Major's Choice</title>
        <meta property="og:title" content="ManageListProduct - Major's Choice" />
    ...
    <body>
        ...
        <div>
            <link href="../css/manage-product-cpu.css" rel="stylesheet" />

            <div class="manage-list-product-container">
                <div class="manage-list-product-header">
                    <div class="navmain-container navmain-root-class-name12">
                ...
                <div class="manage-list-product-body">
                    <div class="manage-list-product-link-page">
                    ...
                    <div class="manage-list-product-root-form">
                        <div class="manage-list-product-table">
                            <h1 class="manage-list-product-text002">Manage CPU</h1>
                            <div class="manage-list-product-list-catevs-search">
                                <div class="manage-list-product-list-category">
                                    <div
                                        data-thq="thq-dropdown"
                                        class="manage-list-product-thq-dropdown list-item"
                                        >
                                        <div
                                            data-thq="thq-dropdown-toggle"
                                            class="manage-list-product-dropdown-toggle"
                                            >
                                            <span class="manage-list-product-text003">
                                                <span>List Category</span>
                                                <br />
                                            </span>
                                            <div
                                                data-thq="thq-dropdown-arrow"
                                                class="manage-list-product-dropdown-arrow"
                                                >
                                                <svg
                                                    viewBox="0 0 1024 1024"
                                                    class="manage-list-product-icon"
                                                    >
                                        ...
                                        <ul
                                            ...
                                            class="manage-list-product-dropdown-list"
                                            >
                                            <li
                                                data-thq="thq-dropdown"
                                ...
                                <a href="/jsp/insertCPU.jsp">
                                    <div class="manage-list-product-add-product thq-button-filled">
                                        <svg
                                            viewBox="0 0 1024 1024"
                                            class="manage-list-product-icon2"
                                            >
                                        <path
                                ...
                                <div class="manage-list-product-search-product">
                                    <input
                                        type="text"
                                        class="manage-list-product-textinput input"
                                        />
                            ...
                            <div class="manage-list-product-list-detail">
                                <form class="manage-list-product-form-tittle">
                                    <div class="manage-list-product-id">
                                        <span class="manage-list-product-text037">
                                            <span>ID</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-image">
                                        <span class="manage-list-product-text040">
                                            <span>Image</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-name">
                                        <span class="manage-list-product-text043">
                                            <span>Name</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-icpu">
                                        <span class="manage-list-product-text046">
                                            <span>IGPU</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-genernation">
                                        <span class="manage-list-product-text049">
                                            <span>Genernation</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-soccet">
                                        <span class="manage-list-product-text052">
                                            <span>Soccet</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-c-t">
                                        <span class="manage-list-product-text055">C-T</span>
                                    </div>
                                    <div class="manage-list-product-clock">
                                        <span class="manage-list-product-text056">
                                            <span>Clock</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-tdp">
                                        <span class="manage-list-product-text059">
                                            <span>TDP</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-selling-price">
                                        <span class="manage-list-product-text062">
                                            <span>Selling Price</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-cost-price">
                                        <span class="manage-list-product-text065">
                                            <span>Cost Price</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-quanity">
                                        <span class="manage-list-product-text068">
                                            <span>Quanity</span>
                                            <br />
                                        </span>
                                    </div>
           ...
           for (CPU cpu : cpus) {
               ...
               String sellingPrice = String.format(Locale.US, "%,.0f", cpu.getSellingPrice());
                                %>
                                <form class="manage-list-product-form-product1">
                                    <div class="manage-list-product-id1">
                                        <span class="manage-list-product-text071">
                                            <span><%= cpu.getId() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-image1">
                                        <img alt="image" src="images/<%= cpu.getId() %>.png" class="manage-list-product-image2" />
                                    </div>
                                    <div class="manage-list-product-name1">
                                        <span class="manage-list-product-text074">
                                            <span><%= cpu.getName() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-icpu1">
                                        <span class="manage-list-product-text077">
                                            <%= cpu.getIgpu() %>
                                        </span>
                                    </div>
                                    <div class="manage-list-product-genernation1">
                                        <span class="manage-list-product-text078">
                                            <span><%= cpu.getGeneration() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-soccet1">
                                        <span class="manage-list-product-text081">
                                            <span><%= cpu.getSocket() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-c-t1">
                                        <span class="manage-list-product-text084">
                                            <span><%= cpu.getCores() %> - <%= cpu.getThreads() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-clock1">
                                        <span class="manage-list-product-text087">
                                            <span><%= cpu.getBaseClock() %> - <%= cpu.getBoostClock() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-tdp1">
                                        <span class="manage-list-product-text090">
                                            <span><%= cpu.getTdp() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-selling-price1">
                                        <span class="manage-list-product-text093">
                                            <span><%= sellingPrice %>đ</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-cost-price1">
                                        <span class="manage-list-product-text096"><%= costPrice %>đ</span>
                                    </div>
                                    <div class="manage-list-product-quanity1">
                                        <span class="manage-list-product-text097">
                                            <span><%= cpu.getQuantity() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-update">
                                        <a href="cpus?service=update&id=<%= cpu.getId() %>">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-icon4 thq-button-icon">
                                        ...
                                        <a href="cpus?service=delete&id=<%= cpu.getId() %>">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-icon6 thq-button-icon">
                ...
                <footer
                    class="footer-footer1 thq-section-padding footer-root-class-name34"
                    >
