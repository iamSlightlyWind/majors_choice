...
<html lang="en">
    <head>
        ...
        <meta
            property="og:title"
            content="ManageListProductPSU - Major's Choice1"
            />
                        ...
                        <div class="manage-list-product-psu-table">
                            ...
                            <div class="manage-list-product-psu-list-catevs-search">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <svg
                                                    viewBox="0 0 1024 1024"
                                                    class="manage-list-product-psu-icon"
                                                    >
                                        ...
                                        <ul
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-psu-dropdown7 list-item"
                                                >
                                                <div
                                                    data-thq="thq-dropdown-toggle"
                                                    class="manage-list-product-psu-dropdown-toggle8"
                                                    >
                                                    <span class="manage-list-product-psu-text27">
                                                        <span>Other</span>
                                                        <br />
                                                    </span>
                                                </div>
                                ...
                                <div class="manage-list-product-psu-search-product">
                                    <input
                                        type="text"
                                        class="manage-list-product-psu-textinput input"
                                        />
                                    <button
                                        class="manage-list-product-psu-search thq-button-filled"
                                        >
    ...
    String sellingPrice = String.format(Locale.US, "%,.0f", psu.getSellingPrice());
                                ...
                                <form class="manage-list-product-psu-form-product1">
                                    ...
                                    <div class="manage-list-product-psu-update">
                                        ...
                                        <a href="psus?service=delete&id=<%= psu.getId() %>">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-psu-icon6 thq-button-icon">
                ...
                <footer
                    class="footer-footer1 thq-section-padding footer-root-class-name57"
                    >
