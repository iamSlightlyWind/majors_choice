                    ...
                    <div class="manage-list-product-psu-root-form">
                        <div class="manage-list-product-psu-table">
                            ...
                            <div class="manage-list-product-psu-list-catevs-search">
                                ...
                                <form action="psus" method="post" class="manage-list-product-psu-search-product"> 
                                    <input type="text" name="searchName" value="${requestScope.searchName}" class="manage-list-product-psu-textinput input" />
                                    <button class="manage-list-product-psu-search thq-button-filled" type="submit" value="Search">
                            ...
                            <div class="manage-list-product-psu-list-detail">
                                ...
                                <form class="manage-list-product-psu-form-product1">
                                    ...
                                    <div class="manage-list-product-psu-update">
                                        ...
                                        <a href="#"  onclick="confirmDelete('psus?service=delete&id=<%= psu.getId() %>');">
                                            <svg viewBox="0 0 1024 1024"
