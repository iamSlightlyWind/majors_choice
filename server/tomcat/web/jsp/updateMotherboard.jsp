                                ...
                                <form action="/motherboards" method="post" enctype="multipart/form-data">
                                    <div class="manage-product-add-form">
                                        ...
                                        <input type="number" name="sellingPrice"
                                               value="<%=motherboard.getSellingPrice()%>"
                                    ...
                                    <div class="manage-product-add-form01">
                                        ...
                                        <input type="number" name="costPrice"
                                               value="<%=motherboard.getCostPrice()%>"
                                    ...
                                    <div class="manage-product-add-form02">
                                        ...
                                        <input type="file" name="image" accept="image/*"
                                               value="<%=motherboard.getImage()%>"
                                               class="manage-product-add-textinput02 input" />
                                    </div>
                                    <div class="manage-product-add-form03">
                                        ...
                                        <div class="manage-product-add-container02">
                                            <input type="text" name="name" value="<%=motherboard.getName()%>"
                                    ...
                                    <div class="manage-product-add-form06">
                                        ...
                                        <div class="manage-product-add-container05">
                                            <input type="text" name="socket"
                                                   value="<%=motherboard.getSocket()%>"
                                                   class="manage-product-add-textinput06 input" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="manage-product-add-form04">
                                        ...
                                        <div class="manage-product-add-container03">
                                            <input type="number" name="igpu" value="<%=motherboard.getIgpu()%>"
                                    ...
                                    <div class="manage-product-add-form07">
                                        ...
                                        <div class="manage-product-add-container06">
                                            <input type="text" name="formFactor"
                                                   value="<%=motherboard.getFormFactor()%>"
                                                   class="manage-product-add-textinput07 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form08">
                                        ...
                                        <div class="manage-product-add-container07">
                                            <input type="text" name="ramType"
                                                   value="<%=motherboard.getRamType()%>"
                                                   class="manage-product-add-textinput08 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form09">
                                        ...
                                        <div class="manage-product-add-container08">
                                            <input type="number" name="maxRamCapacity"
                                                   value="<%=motherboard.getMaxRamCapacity()%>"
                                                   class="manage-product-add-textinput09 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form10">
                                        ...
                                        <div class="manage-product-add-container09">
                                            <input type="number" name="maxRamSpeed"
                                                   value="<%=motherboard.getMaxRamSpeed()%>"
                                                   class="manage-product-add-textinput10 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form11">
                                        ...
                                        <div class="manage-product-add-container10">
                                            <input type="number" name="ramSlots"
                                                   value="<%=motherboard.getRamSlots()%>"
                                                   class="manage-product-add-textinput11 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-form12">
                                        ...
                                        <div class="manage-product-add-container11">
                                            <input type="number" name="wifi" value="<%=motherboard.getWifi()%>"
                                    ...
                                    <div class="manage-product-add-form12">
                                        ...
                                        <div class="manage-product-add-container11">
                                            <input type="number" name="quantity"
                                                   value="<%=motherboard.getQuantity()%>"
                                                   class="manage-product-add-textinput12 input" />
                                        </div>
                                    </div>
                                    <div class="manage-product-add-container13">
                                        <input type="submit" name="submit" value="Update Mobo"
