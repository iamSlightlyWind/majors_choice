...
<html lang="en">
    <head>
        <title>ManageListProductCASE - Major's Choice1</title>
        <meta
            property="og:title"
            content="ManageListProductCASE - Major's Choice1"
            />
    ...
    <body>
        ...
        <div>
            <link href="../css/manage-product-case.css" rel="stylesheet" />

            <div class="manage-list-product-case-container">
                <div class="manage-list-product-case-header">
                    <div class="navmain-container navmain-root-class-name59">
                    ...
                    <div class="navstaff-container navstaff-root-class-name56">
                ...
                <div class="manage-list-product-case-body">
                    <div class="manage-list-product-case-link-page">
                        <span class="manage-list-product-case-text thq-body-small thq-link">
                            Home&nbsp;
                        </span>
                        <span class="manage-list-product-case-text01">
                            / Manager Warehouse
                        </span>
                    </div>
                    <div class="manage-list-product-case-root-form">
                        <div class="manage-list-product-case-table">
                            <h1 class="manage-list-product-case-text02">Manage CASE</h1>
                            <div class="manage-list-product-case-list-catevs-search">
                                <div class="manage-list-product-case-list-category">
                                    <div
                                        data-thq="thq-dropdown"
                                        class="manage-list-product-case-thq-dropdown list-item"
                                        >
                                        <div
                                            data-thq="thq-dropdown-toggle"
                                            class="manage-list-product-case-dropdown-toggle"
                                            >
                                            <span class="manage-list-product-case-text03">
                                                <span>List Category</span>
                                                <br />
                                            </span>
                                            <div
                                                data-thq="thq-dropdown-arrow"
                                                class="manage-list-product-case-dropdown-arrow"
                                                >
                                                <svg
                                                    viewBox="0 0 1024 1024"
                                                    class="manage-list-product-case-icon"
                                                    >
                                        ...
                                        <ul
                                            ...
                                            class="manage-list-product-case-dropdown-list"
                                            >
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown list-item"
                                                >
                                                <a href="/cpus">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle1"
                                                        >
                                                        <span class="manage-list-product-case-text06">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown1 list-item"
                                                >
                                                <a href="/gpus">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle2"
                                                        >
                                                        <span class="manage-list-product-case-text09">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown2 list-item"
                                                >
                                                <a href="/motherboards">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle3"
                                                        >
                                                        <span class="manage-list-product-case-text12">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown3 list-item"
                                                >
                                                <a href="/psus">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle4"
                                                        >
                                                        <span class="manage-list-product-case-text15">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown4 list-item"
                                                >
                                                <a href="/rams">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle5"
                                                        >
                                                        <span class="manage-list-product-case-text18">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown5 list-item"
                                                >
                                                <a href="/ssds">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle6"
                                                        >
                                                        <span class="manage-list-product-case-text21">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown6 list-item"
                                                >
                                                <a href="/cases">
                                                    <div
                                                        data-thq="thq-dropdown-toggle"
                                                        class="manage-list-product-case-dropdown-toggle7"
                                                        >
                                                        <span class="manage-list-product-case-text24">
                                            ...
                                            <li
                                                data-thq="thq-dropdown"
                                                class="manage-list-product-case-dropdown7 list-item"
                                                >
                                                <div
                                                    data-thq="thq-dropdown-toggle"
                                                    class="manage-list-product-case-dropdown-toggle8"
                                                    >
                                                    <span class="manage-list-product-case-text27">
                                                        <span>Other</span>
                                                        <br />
                                                    </span>
                                                </div>
                                ...
                                <a href="/jsp/insertCase.jsp">
                                    <div
                                        class="manage-list-product-case-add-product thq-button-filled"
                                        >
                                        <svg
                                            viewBox="0 0 1024 1024"
                                            class="manage-list-product-case-icon2"
                                            >
                                        <path
                                        ...
                                        <span class="manage-list-product-case-text30">
                                            Add Product
                                        </span>
                                    </div>
                                </a>
                                <div
                                    id="fromup"
                                    onclick="openForm"
                                    class="manage-list-product-case-import-file thq-button-filled"
                                    >
                                    <span class="manage-list-product-case-text31">
                                ...
                                <div class="manage-list-product-case-search-product">
                                    <input
                                        type="text"
                                        class="manage-list-product-case-textinput input"
                                        />
                                    <button
                                        class="manage-list-product-case-search thq-button-filled"
                                        >
                                        <span
                                            class="manage-list-product-case-text34 thq-body-small"
                                            >
                                            <span>Search</span>
                                            <br />
                                        </span>
                            ...
                            <div class="manage-list-product-case-list-detail">
                                <form class="manage-list-product-case-form-tittle">
                                    <div class="manage-list-product-case-id">
                                        <span class="manage-list-product-case-text37">
                                            <span>ID</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-image">
                                        <span class="manage-list-product-case-text40">
                                            <span>Image</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-name">
                                        <span class="manage-list-product-case-text43">
                                            <span>Name</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-form-factor">
                                        <span class="manage-list-product-case-text46">
                                            <span>FormFactor</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-color">
                                        <span class="manage-list-product-case-text49">
                                            <span>Color</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-selling-price">
                                        <span class="manage-list-product-case-text52">
                                            <span>Selling Price</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-cost-price">
                                        <span class="manage-list-product-case-text55">
                                            <span>Cost Price</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-quanity">
                                        <span class="manage-list-product-case-text58">
                                            <span>Quanity</span>
                                            <br />
                                        </span>
                                    </div>
    ...
    for (Case caseItem : cases) {
        ...
        String sellingPrice = String.format(Locale.US, "%,.0f", caseItem.getSellingPrice());
                                %>
                                <form class="manage-list-product-case-form-product1">
                                    <div class="manage-list-product-case-id1">
                                        <span class="manage-list-product-case-text61">
                                            <span><%= caseItem.getId() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-image1">
                                        <img
                                            alt="image"
                                            src="images/<%= caseItem.getId() %>.png"
                                            class="manage-list-product-case-image2"
                                            />
                                    </div>
                                    <div class="manage-list-product-case-name1">
                                        <span class="manage-list-product-case-text64">
                                            <span><%= caseItem.getName() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-form-factor1">
                                        <span class="manage-list-product-case-text67">
                                            <%= caseItem.getFormFactor() %>
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-color1">
                                        <span class="manage-list-product-case-text68">
                                            <span><%= caseItem.getColor() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-selling-price1">
                                        <span class="manage-list-product-case-text71">
                                            <span><%= sellingPrice %>đ</span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-cost-price1">
                                        <span class="manage-list-product-case-text74"><%= costPrice %>đ</span>
                                    </div>
                                    <div class="manage-list-product-case-quanity1">
                                        <span class="manage-list-product-case-text75">
                                            <span><%= caseItem.getQuantity() %></span>
                                            <br />
                                        </span>
                                    </div>
                                    <div class="manage-list-product-case-update">
                                        <a href="cases?service=update&id=<%= caseItem.getId() %>">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-case-icon4 thq-button-icon">
                                        ...
                                        <a href="cases?service=delete&id=<%= caseItem.getId() %>">
                                            <svg viewBox="0 0 1024 1024" class="manage-list-product-case-icon6 thq-button-icon">
                ...
                <footer
                    class="footer-footer1 thq-section-padding footer-root-class-name60"
                    >
