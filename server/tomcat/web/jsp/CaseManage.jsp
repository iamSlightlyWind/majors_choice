...
<html lang="en">
    ...
    <head>
        ...
        <meta property="og:title" content="ManageListProductCASE - Major's Choice1" />
    ...
    <body>
        ...
        <div>
            ...
            <div class="manage-list-product-case-container">
                        ...
                        <div class="manage-list-product-case-table">
                            ...
                            <div class="manage-list-product-case-list-catevs-search">
                                    ...
                                    <div data-thq="thq-dropdown"
                                        ...
                                        <div data-thq="thq-dropdown-toggle"
                                            ...
                                            <div data-thq="thq-dropdown-arrow"
                                                ...
                                                <svg viewBox="0 0 1024 1024" class="manage-list-product-case-icon">
                                ...
                                <a href="/jsp/insertCase.jsp">
                                    <div class="manage-list-product-case-add-product thq-button-filled">
                                        <svg viewBox="0 0 1024 1024" class="manage-list-product-case-icon2">
                                        <path
                                ...
                                <body>
                                    <form id="importExcelForm" action="cases?service=importExcel" method="post"
                            ...
                            <div class="manage-list-product-case-list-detail">
                                ...
                                <form class="manage-list-product-case-form-product1">
                                    ...
                                    <div class="manage-list-product-case-image1">
                                        <img alt="image" src="images/<%= caseItem.getId() %>.png"
                                    ...
                                    <div class="manage-list-product-case-cost-price1">
                                        <span class="manage-list-product-case-text74">
                                            <%= costPrice %>đ
                                        </span>
                                    </div>
                                    ...
                                    <div class="manage-list-product-case-update">
                                        <a href="cases?service=update&id=<%= caseItem.getId() %>">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-case-icon4 thq-button-icon">
                                            <path
                                        ...
                                        <a href="#"  onclick="confirmDelete('cases?service=delete&id=<%= caseItem.getId() %>');">
                                            <svg viewBox="0 0 1024 1024"
                                                 class="manage-list-product-case-icon6 thq-button-icon">
                                            <path
                ...
                <footer class="footer-footer1 thq-section-padding footer-root-class-name60">
