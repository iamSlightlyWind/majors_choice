...
<%@page import="java.util.Vector,packages.SSD"%>
<!DOCTYPE html>
<html lang="en">
    <head>
                            ...
                            <form action="/ssds?service=insertSSD" method="post" enctype="multipart/form-data">
                                ...
                                <div class="manage-product-add-form04">
                                    ...
                                    <div class="manage-product-add-container03">
                                        <input type="text" placeholder="Text" name="interface" class="manage-product-add-textinput04 input" />
                                    </div>
                                </div>
                                ...
                                <div class="manage-product-add-form06">
                                    ...
                                    <div class="manage-product-add-container05">
                                        <input type="number" placeholder="Number" name="cache" class="manage-product-add-textinput06 input" />
                                    </div>
                                </div>
                                ...
                                <div class="manage-product-add-container13">
                                    <input type="submit" name="submit" value="Add SSD" class="manage-product-add-button thq-button-filled button" />
