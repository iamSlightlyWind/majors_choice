              ...
              <div class="manage-customer-table">
                ...
                <div class="manage-customer-list-detail">
                  ...
                  <c:forEach var="staff" items="${requestScope.staffs}">
                    <div class="manage-customer-form-customer11">
                      ...
                      <div class="manage-customer-active1">
                        <span class="manage-customer-text36">
                          <span>${staff.active == 1 ? 'Activated' : 'Deactivated'}</span>
                          <br />
                        </span>
                      </div>
                      <form form action="/editprofile" method="get" class="manage-customer-date-joined1">
                        <span class="manage-customer-text39">
                          <span><input type="hidden" name="actor" value="staffs">
                      ...
                      <div class="manage-customer-update1">
                        <span class="manage-customer-text42 thq-link">
                          <span><a
                              href="/editprofile?id=${staff.id}&action=update&actor=staffs&user=${staff.username}">Update</a></span>
                          <br />
                        </span>
                      </div>
