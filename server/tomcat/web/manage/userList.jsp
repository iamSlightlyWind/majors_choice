...
<html lang="en">
  <head>
    <title>ManageListCustomer - Major's Choice1</title>
    <meta property="og:title" content="ManageListCustomer - Major's Choice1" />
  ...
  <body>
    ...
    <div>
      ...
      <div class="manage-list-customer-container">
            ...
            <div class="manage-list-customer-table">
              ...
              <div class="manage-list-customer-control">                  
                  ...
                  <input
                    ...
                    <%--class="manage-list-customer-textinput input"--%>
                  />
                  <button class="manage-list-customer-search thq-button-filled" type="submit" name="searchIN" value="user">
              ...
              <div class="manage-list-customer-list-detail">
                ...
                <form class="manage-list-customer-form-order1">
                  ...
                  <div class="manage-list-customer-status1">
                    <span class="manage-list-customer-text24">${user.active == 1 ? 'Activated' : (user.active == 0 ? 'Not Activated' :
                            'Deactivated')}</span>
                  </div>
                  ...
                  <div class="manage-list-customer-view">
                      <a href="/editprofile?id=${user.id}&action=update&actor=users&user=${user.username}"><svg
                              viewBox="0 0 1024 1024"
                              class="manage-list-customer-icon thq-button-icon"
                              >
                          <path
                              ...
                              ></path></svg
                          ></a>
                      <a href="#" onclick="confirmDelete('/editprofile?id=${user.id}&action=delete&actor=users&user=${user.username}');">
                          <svg
                              viewBox="0 0 1024 1024"
                              class="manage-list-customer-icon2 thq-button-icon"
                              >
                          <path
        ...
        <footer
          class="footer-footer1 thq-section-padding footer-root-class-name46"
        >
