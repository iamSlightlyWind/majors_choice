      ...
      <div>
        ...
        <div class="manage-customer-container">
          ...
          <div class="manage-customer-body">
                ...
                <div class="manage-customer-list-catevs-search">
                    <form action="/manage/profile" method="post">
                        <div class="manage-customer-search-product">
                            ...
                            <button type="submit" class="manage-customer-search thq-button-filled" name="searchIN" value="user"> 
                    ...
                    <div class="manage-customer-form-customer1">
                      ...
                      <div class="manage-customer-active1">
                        <span class="manage-customer-text36">
                          <span>${user.active == 1 ? 'Activated' : (user.active == 0 ? 'Not Activated' :
                            'Deactivated')}</span>
                          <br />
                        </span>
                      </div>
                      ...
                      <div class="manage-customer-update1">
                        <span class="manage-customer-text42 thq-link">
                          <span><a
                              href="/editprofile?id=${user.id}&action=update&actor=users&user=${user.username}">Update</a></span>
                          <br />
                        </span>
                      </div>
            ...
            <footer class="footer-footer1 thq-section-padding footer-root-class-name44">
