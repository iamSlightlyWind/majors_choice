<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      <title>Customer List - Major's Choice1</title>
      <meta property="og:title" content="Customer List - Major's Choice1" />
    ...
    <body>
      ...
      <div>
        <link href="../css/manage-list-customer.css" rel="stylesheet" />

        <div class="manage-list-customer-container">
          <div class="manage-list-customer-header">
            <div class="navmain-container navmain-root-class-name50">
                ...
                <header data-thq="thq-navbar" class="navmain-navbar-interactive">
                  ...
                  <div data-thq="thq-navbar-nav" class="navmain-desktop-menu">
                    ...
                    <div class="navmain-buttons">
                      <a href="#" rel="noreferrer noopener" class="navmain-link1">
                      ...
                      <a href="/" rel="noreferrer noopener" class="navmain-account thq-button-filled">
            ...
            <% String role=(String) request.getSession().getAttribute("table"); if ("staff".equals(role) || "manager"
              .equals(role)) { %>
              <div class="navstaff-container navstaff-root-class-name52">
          ...
          <div class="manage-list-customer-body">
            <div class="manage-list-customer-link-page">
              <span class="manage-list-customer-text thq-body-small thq-link">
                <a href="/">Home&nbsp;</a>
              </span>
              <span class="manage-list-customer-text01">/ Manager Cutomer</span>
            </div>
            <div class="manage-list-customer-root-form">
              <div class="manage-list-customer-table">
                <h1 class="manage-list-customer-text02">Manage Customer</h1>
                <span id="status-span" style="display:none;">${status}</span>
                <div class="manage-list-customer-control">
                  <form action="/manage/profile" method="post">
                    <div class="manage-list-customer-search-product">
                      <input type="text" name="searchName" value="${searchName}" placeholder="Search by FullName"
                        style="background-color: bisque" <%--class="manage-list-customer-textinput input" --%>
                      />
                      <button class="manage-list-customer-search thq-button-filled" type="submit" name="searchIN"
                        value="user">
                        <span class="manage-list-customer-text03 thq-body-small">
                          <span>Search</span>
                          <br />
                        </span>
                      </button>
                ...
                <div class="manage-list-customer-list-detail">
                  <form class="manage-list-customer-form-tittle">
                    <div class="manage-list-customer-id">
                      <span class="manage-list-customer-text06">ID</span>
                    </div>
                    <div class="manage-list-customer-date">
                      <span class="manage-list-customer-text07">
                        <span>Full Name</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-customer-customer">
                      <span class="manage-list-customer-text10">
                        <span>Email</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-customer-status">
                      <span class="manage-list-customer-text13">
                        <span>Status</span>
                        <br />
                      </span>
                    </div>
                    <div class="manage-list-customer-items">
                      <span class="manage-list-customer-text16">
                  ...
                  <c:forEach var="user" items="${users}">
                    <form class="manage-list-customer-form-order1">
                      <div class="manage-list-customer-id1">
                        <span class="manage-list-customer-text19">
                          <span>${user.id}</span>
                          <br />
                        </span>
                      </div>
                      <div class="manage-list-customer-date1">
                        <span class="manage-list-customer-text22">${user.fullName}</span>
                      </div>
                      <div class="manage-list-customer-customer1">
                        <span class="manage-list-customer-text23">
                          ${user.email}
                        </span>
                      </div>
                      <div class="manage-list-customer-status1">
                        <span class="manage-list-customer-text24">${user.active == 1 ? 'Activated' : (user.active == 0 ?
                          'Not Activated' :
                          'Deactivated')}</span>
                      </div>
                      <div class="manage-list-customer-items1">
                        <span class="manage-list-customer-text25">${user.dateJoined}</span>
                      </div>
                      <div class="manage-list-customer-view">
                        <a href="/editprofile?id=${user.id}&action=update&actor=users&user=${user.username}"><svg
                            viewBox="0 0 1024 1024" class="manage-list-customer-icon thq-button-icon">
                            <path
                        ...
                        <a href="#"
                          onclick="confirmDelete('/editprofile?id=${user.id}&action=delete&actor=users&user=${user.username}');">
                          <svg viewBox="0 0 1024 1024" class="manage-list-customer-icon2 thq-button-icon">
                            <path
              ...
              <div class="manage-list-customer-heading-table"></div>
            </div>
          </div>
          <footer class="footer-footer1 thq-section-padding footer-root-class-name46">
