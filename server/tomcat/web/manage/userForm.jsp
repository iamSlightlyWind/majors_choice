...
<html lang="en">
  <head>
    <title>ManageProfileCustomer - Major's Choice1</title>
    <meta
      property="og:title"
      content="ManageProfileCustomer - Major's Choice1"
    />
  ...
  <body>
    ...
    <div>
      <link href="../css/manage-profile-customer.css" rel="stylesheet" />

      <div class="manage-profile-customer-container">
        <div class="manage-profile-customer-header">
          <div class="navmain-container navmain-root-class-name46">
                ...
                <div data-thq="thq-navbar-nav" class="navmain-desktop-menu">
                  <nav class="navmain-links">
                    ...
                    <div class="navmain-container3">
                      <input
                        type="text"
                        placeholder="Search for product" name="searchName"
          ...
          <% String role=(String) request.getSession().getAttribute("table"); if ("staff".equals(role)
                  || "manager" .equals(role)) { %>           
          <div class="navstaff-container navstaff-root-class-name48">
        ...
        <div class="manage-profile-customer-body">
          <div class="manage-profile-customer-link-page">
            <div class="manage-profile-customer-container1">
              <span
                class="manage-profile-customer-text thq-body-small thq-link"
              >
                  <a href="/">Home&nbsp;</a>
              </span>
              <span
                class="manage-profile-customer-text01 thq-body-small thq-link"
              >
                  <a href="/manage/profile?actor=user">&nbsp;/ Manage Customer</a>
              </span>
              <span class="manage-profile-customer-text02 thq-body-small">
                &nbsp;/ Edit Customer&nbsp;
              </span>
            </div>
          </div>
          ...
          <div class="manage-profile-customer-root">
            <div class="manage-profile-customer-container2">
              <h1 class="manage-profile-customer-text03">Edit Customer</h1>
            </div>
            <form class="manage-profile-customer-container3" action="/manage/profile/user" method="post" id="profileForm">
              <div class="manage-profile-customer-form">
                <span class="manage-profile-customer-text04">
                  <span>Status</span>
                  <br />
                </span>
                <select class="manage-profile-customer-select" name="active" required>
              ...
              <div class="manage-profile-customer-form1">
                <span class="manage-profile-customer-text07">Full Name</span>
                <input
                  type="text"
                  name="fullname"
                  value="${user.fullName}" required
                  placeholder="Name customer"
                  class="manage-profile-customer-textinput input"
                />
              </div>
              <div class="manage-profile-customer-form2">
                <span class="manage-profile-customer-text08">
                  <span>Email</span>
                  <br />
                </span>
                <input
                  ...
                  placeholder="email"
                  class="manage-profile-customer-textinput1 input"
                />
              </div>
              <div class="manage-profile-customer-form3">
                <span class="manage-profile-customer-text11">
                  <span>Phone</span>
                  <br />
                </span>
                <input
                  ...
                  placeholder="phone"
                  class="manage-profile-customer-textinput2 input"
                />
              </div>
              <div class="manage-profile-customer-form4">
                <span class="manage-profile-customer-text14">
                  <span>Address</span>
                  <br />
                </span>
                <input
                  ...
                  placeholder="Address"
                  class="manage-profile-customer-textinput3 input"
                />
              </div>
              <div class="manage-profile-customer-form5">
                <span class="manage-profile-customer-text17">
                ...
                <input
                  ...
                  readonly
                  class="manage-profile-customer-textinput4 input"
                />
              ...
              <button
                type="submit"
                class="manage-profile-customer-button button thq-button-outline"
              >
                <span class="manage-profile-customer-text20">
                  <span>Save</span>
                  <br />
                </span>
              </button>
        ...
        <div class="manage-profile-customer-footer">
          <footer
