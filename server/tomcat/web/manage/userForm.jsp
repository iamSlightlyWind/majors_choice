      ...
      <div>
        ...
        <div class="edit-customer-container">
          ...
          <div class="edit-customer-body">
            ...
            <div class="edit-customer-root">
              <div class="edit-customer-container2">
                <h1 class="edit-customer-text03">Edit Customer</h1>
              </div>
              <div class="edit-customer-container3">
                <form action="/manage/profile/user" method="post" id="profileForm">
                  ...
                  <div class="edit-customer-form1">
                    ...
                    <input type="text" placeholder="Name customer" class="edit-customer-textinput input" name="fullname"
                  ...
                  <div class="edit-customer-form2">
                    ...
                    <input type="email" placeholder="email" class="edit-customer-textinput1 input" name="email"
                  ...
                  <div class="edit-customer-form3">
                    ...
                    <input type="tel" placeholder="phone" class="edit-customer-textinput2 input" name="phoneNumber"
                  ...
                  <div class="edit-customer-form4">
                    ...
                    <input type="text" placeholder="Address" class="edit-customer-textinput3 input" name="address"
          ...
          <div class="edit-customer-footer">
            <footer class="footer-footer1 thq-section-padding footer-root-class-name42">
