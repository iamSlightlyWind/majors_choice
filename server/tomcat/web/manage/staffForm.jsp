...
<html lang="en">
  <head>
    <title>ManageProfileStaff - Major's Choice1</title>
    <meta property="og:title" content="ManageProfileStaff - Major's Choice1" />
  ...
  <body>
    ...
    <div>
      <link href="../css/manage-profile-staff.css" rel="stylesheet" />

      <div class="manage-profile-staff-container">
        <div class="manage-profile-staff-header">
                  ...
                  <nav class="navmain-links">
                    <form action="/" method="post">
                      <div class="navmain-container3">
                        ...
                        />
                        <button
                          class="navmain-search thq-button-filled"
                          type="submit"
                        >
                    ...
                    <div class="navmain-container4">
                      ...
                      <% if
                      (!"staff".equals(request.getSession().getAttribute("table")))
                      { %>
                      <a
                        href="/order"
                        class="navmain-manager-order thq-body-small thq-link"
                ...
                <div data-thq="thq-mobile-menu" class="navmain-mobile-menu">
                  <div class="navmain-nav">
                    ...
                    <nav class="navmain-links1">
                      ...
                      <% String table=(String)
                      request.getSession().getAttribute("table"); if
                      (!"staff".equals(table)) { %>
                      <span class="thq-body-small thq-link">
          ...
          <div class="navstaff-container navstaff-root-class-name48">
            <div class="navstaff-manager">
              ...
              <a
                href="/stats"
                class="navstaff-mgt-report text1 thq-link1 thq-body-small"
              >
                Statistics
              </a>
            </div>
        ...
        <div class="manage-profile-staff-body">
          <div class="manage-profile-staff-link-page">
            <div class="manage-profile-staff-container1">
              <span class="manage-profile-staff-text thq-body-small thq-link">
                <a href="/">Home&nbsp;</a>
              </span>
              <span class="manage-profile-staff-text01 thq-body-small thq-link">
                <a href="/manage/profile?actor=staff">&nbsp;/ Manage Staff</a>
              </span>
              <span class="manage-profile-staff-text02 thq-body-small">
                &nbsp;/ Profile Staff&nbsp;
              </span>
            </div>
          </div>
          <div class="manage-profile-staff-root">
            <div class="manage-profile-staff-container2">
              <h1 class="manage-profile-staff-text03">
                <span>Profile Staff</span>
                <br />
              </h1>
            </div>
            <form class="manage-profile-staff-container3" action="/manage/profile/staff" method="post" id="profileForm">
             <c:if test="${submitAction=='Update'}">   
              <div class="manage-profile-staff-form">
                <span class="manage-profile-staff-text06">
                  <span>Status</span>
                  <br />
                </span>
                <select required="true" class="manage-profile-staff-select" name="active">
                  <option value="1" ${staff.active==1 ? 'selected' : '' }>Activated</option>
                  <option value="-1" ${staff.active==-1 ? 'selected' : '' }>Deactivated</option>
                </select>
              </div>
             </c:if>   
              <div class="manage-profile-staff-form1">
                <span class="manage-profile-staff-text09">Full Name</span>
                <input
                  type="text"
                  required="true"
                  name="fullname"
                  value="${staff.fullName}"  
                  placeholder="Full Name Staff"
                  class="manage-profile-staff-textinput input"
                />
              </div>
              <div class="manage-profile-staff-form2">
                <span class="manage-profile-staff-text10">
                  <span>Username</span>
                  <br />
                </span>
                <input
                  ...
                  class="manage-profile-staff-textinput1 input"
                />
              </div>
              <div class="manage-profile-staff-form3">
                <span class="manage-profile-staff-text13">
                  <span>Password</span>
                  <br />
                </span>
                <input
                  ...
                  class="manage-profile-staff-textinput2 input"
                />
              </div>
              ...
              <button
                  type="submit"
                class="manage-profile-staff-button button thq-button-outline"
              >
                <span class="manage-profile-staff-text16">
        ...
        <div class="manage-profile-staff-footer">
          <footer
            class="footer-footer1 thq-section-padding footer-root-class-name53"
          >
