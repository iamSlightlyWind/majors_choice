...
<html lang="en">
  ...
  <body>
    ...
    <div>
      <link href="../css/auth-reset.css" rel="stylesheet" />

      <div class="auth-reset-container">
        <div class="auth-reset-header">
          <div class="navlogout-container navlogout-root-class-name4">
          ...
          <div class="auth-reset-container1">
            <div
              class="resetpass-container thq-section-padding resetpass-root-class-name"
            >
              <div
                class="resetpass-max-width thq-section-padding thq-section-max-width"
              >
                <div class="resetpass-form">
                  ...
                  <form class="resetpass-form1" action="/auth/recovery" method="post">
                    ...
                    <button
                      type="submit"
                      class="resetpass-button thq-button-filled"
                    >
                    ...
                    <div class="resetpass-container1">
                      ...
                      <a
                        href="/auth/login.jsp"
                        class="resetpass-button1 thq-button-outline"
                      >
                    ...
                    <div class="resetpass-container2">
                      <button
                        type="submit"
                        class="resetpass-button2 thq-button-filled"
                      >
