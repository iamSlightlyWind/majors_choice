...
<head>
  <title>ResetPassword - Major's Choice2</title>
  <meta property="og:title" content="ResetPassword - Major's Choice2" />
        ...
        <div class="navbar-container navbar-root-class-name3">
          ...
          <header class="navbar-container2">
            <header data-thq="thq-navbar" class="navbar-navbar-interactive">
              <img alt="pastedImage" src="./" class="navbar-pasted-image" />
                ...
                <div class="navbar-nav">
                  <div class="navbar-top">
                    <div class="navbar-container5">
                      <img alt="pastedImage" src="image/Logo.png" class="navbar-pasted-image1" />
                    </div>
          ...
          <div class="resetpass-container thq-section-padding resetpass-root-class-name">
            <div class="resetpass-max-width thq-section-padding thq-section-max-width">
              ...
              <div class="resetpass-container2">
                ...
                <a href="/auth/register.jsp" class="resetpass-button1 thq-button-outline">
                  <span class="resetpass-text6 thq-body-small">
                    <span>Login</span>
                  </span>
                </a>
              </div>
              <div class="resetpass-container3">
