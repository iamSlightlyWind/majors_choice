<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        <title>RegisterUsserGoogle - Major's Choice1</title>
        <meta property="og:title" content="RegisterUsserGoogle - Major's Choice1" />
    ...
    <body>
        ...
        <div>
            <link href="./register-usser-google.css" rel="stylesheet" />

            <div class="register-usser-google-container">
                <div class="register-usser-google-header">
                    <div class="navbar-container navbar-root-class-name36">
                    ...
                    <div class="menu-function-container menu-function-root-class-name39">
                ...
                <div class="register-usser-google-body">
                    <div class="register-by-gg-container thq-section-padding register-by-gg-root-class-name">
                        <div class="register-by-gg-form-root">
                            <div class="register-by-gg-form">
                                ...
                                <form class="register-by-gg-form1">
                                    ...
                                    <div class="register-by-gg-email">
                                        ...
                                        <input type="email" id="thq-sign-in-3-email" required="true"
                                    ...
                                    <div class="register-by-gg-date-of-birth">
                                        ...
                                        <input type="date" required="true" placeholder="Registered email"
                                            class="register-by-gg-textinput4 thq-input thq-body-large" />
                                    </div>
                                    <a href="home-page.html" class="register-by-gg-button thq-button-filled">
