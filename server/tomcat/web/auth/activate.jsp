...
<html lang="en">
  <head>
    <title>AuthActivate - Major's Choice</title>
    <meta property="og:title" content="AuthActivate - Major's Choice" />
  ...
  <body>
    ...
    <div>
      <link href="../css/auth-activate.css" rel="stylesheet" />

      <div class="auth-activate-container">
        <div class="auth-activate-header">
          <div class="navlogout-container navlogout-root-class-name1">
          ...
          <div class="auth-activate-container1">
            <div
              class="activate-acc1-container thq-section-padding activate-acc1-root-class-name"
            >
              <div
                class="activate-acc1-max-width thq-section-padding thq-section-max-width"
              >
                    ...
                    <div class="activate-acc1-email">
                      <div class="activate-acc1-container1">
                        <label
                          ...
                          class="activate-acc1-text1 thq-body-large"
                        >
                        ...
                        <label
                          for="thq-sign-in-1-password"
                          class="activate-acc1-user-name thq-body-large"
                        >
                          <span>&nbsp;${user}</span>
                          <br />                          
                        </label>
                      ...
                      <input
                        ...
                        class="activate-acc1-textinput thq-input thq-body-large"
                      />
                    </div>
                    <p>${activateStatus}</p>
                    <button
                      type="submit"
                      class="activate-acc1-button thq-button-filled"
                    >
