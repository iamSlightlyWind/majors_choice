          ...
          <div class="index-welcome">
            <div class="index-container1">
              ...
              <div class="index-container2">
                <button
                  type="button"
                  class="index-button button thq-button-outline"
                >
                ...
                <button
                  type="button"
                  class="index-button1 thq-button-filled button"
                >
            ...
            <div class="index-list-category">
              ...
              <div data-thq="thq-dropdown" class="index-thq-dropdown list-item">
                <div
                  ...
                  class="index-dropdown-toggle-cpu"
                >
                ...
                <ul data-thq="thq-dropdown-list" class="index-dropdown-list">
                  <li data-thq="thq-dropdown" class="index-dropdown list-item">
                    ...
                    <ul
                      ...
                      class="index-dropdown-list001"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown001 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle001"
                        >
                            <span class="index-text0015"> <a href="/FilterCPU?brand=amd">AMD</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow002"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown004 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle004"
                        >
                          <span class="index-text0022"><a href="/FilterCPU?brand=intel">Intel</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow003"
                          >
                          </div>
                        </div>                           
                      </li>         
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown026 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle026"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list008"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown027 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle027"
                        >
                          <span class="index-text0084"><a href="/FilterCPU?generation=Cezanne">Cezanne</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow009"
                          >
                          </div>
                        </div>                   
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown030 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle030"
                        >
                          <span class="index-text0091"><a href="/FilterCPU?generation=Zen 3">Zen 3</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow010"
                          >
                          </div>
                        </div>
                      ...
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown034 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle034"
                        >
                          <span class="index-text0101"><a href="/FilterCPU?generation=raphael">Raphael</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow011"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown038 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle038"
                        >
                          <span class="index-text0111"><a href="/FilterCPU?generation=raptorlake">Raptor Lake</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow012"
                          >
                          </div>
                        </div>                      
                      </li>                    
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown052 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle052"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list015"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown053 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle053"
                        >
                          <span class="index-text0153"><a href="/FilterCPU?socket=am4">AM4</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow016"
                          >
                          </div>
                        </div>                        
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown056 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle056"
                        >
                          <span class="index-text0160"><a href="/FilterCPU?socket=am5">AM5</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow017"
                          >
                          </div>
                        </div>
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown060 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle060"
                        >
                          <span class="index-text0170"><a href="/FilterCPU?socket=lga1700">LGA 1700</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow018"
                          >
                          </div>
                        </div>
                      </li>  
              ...
              <div
                data-thq="thq-dropdown"
                class="index-thq-dropdown1 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  class="index-dropdown-toggle-cpu1"
                >
                ...
                <ul data-thq="thq-dropdown-list" class="index-dropdown-list024">
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown093 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle085"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list025"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown094 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle086"
                        >
                          <span class="index-text0245"><a href="/FilterGPU?brand=amd">AMD</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow024"
                          >
                          </div>
                        </div>                      
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown097 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle089"
                        >
                          <span class="index-text0252"><a href="/FilterGPU?brand=nvidia">NVIDIA</a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow025"
                          >
                          </div>
                        </div>                      
                      </li>
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown119 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle111"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list032"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown120 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle112"
                        >
                          <span class="index-text0314"><a href="/FilterGPU?generation=rdna"><span>RDNA</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow031"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown123 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle115"
                        >
                          <span class="index-text0321"> <a href="/FilterGPU?generation=ampere"><span>Ampere</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow032"
                          >
                          </div>
                        </div>                        
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown127 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle119"
                        >
                          <span class="index-text0331"><a href="/FilterGPU?generation=adalovelace"><span>Ada LoveLace</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow033"
                          >
                          </div>
                        </div>                     
                      </li>   
              ...
              <div
                data-thq="thq-dropdown"
                class="index-thq-dropdown2 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  class="index-dropdown-toggle-cpu2"
                >
                ...
                <ul data-thq="thq-dropdown-list" class="index-dropdown-list048">
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown186 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle170"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list049"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown187 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle171"
                        >
                          <span class="index-text0475"><a href="/FilterMotherBoard?socket=am4"><span>AM4</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow046"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown190 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle174"
                        >
                          <span class="index-text0482"><a href="/FilterMotherBoard?socket=am5"><span>AM5</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow047"
                          >
                          </div>
                        </div>                      
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown194 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle178"
                        >
                          <span class="index-text0492"><a href="/FilterMotherBoard?socket=lga1700"><span>LGA 1700</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow048"
                          >
                          </div>
                        </div>                      
                      </li>
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown212 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle196"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list056"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown213 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle197"
                        >
                          <span class="index-text0544"><a href="/FilterMotherBoard?formFactor=atx"><span>ATX</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow053"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown216 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle200"
                        >
                          <span class="index-text0551"><a href="/FilterMotherBoard?formFactor=matx"><span>mATX</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow054"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown220 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle204"
                        >
                          <span class="index-text0561"><a href="/FilterMotherBoard?formFactor=mITX"><span>mITX</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow055"
                          >
                          </div>
                        </div>                    
                      </li>
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown238 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle222"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list063"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown239 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle223"
                        >
                          <span class="index-text0613"><a href="/FilterMotherBoard?ramType=ddr4"><span>DDR4</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow060"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown242 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle226"
                        >
                          <span class="index-text0620"><a href="/FilterMotherBoard?ramType=ddr5"><span>DDR5</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow061"
                          >
                          </div>
                        </div>                        
                      </li>                   
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle223"
                        >
                          <span class="index-text0613"><a href="/FilterMotherBoard?wifi=1"><span>Yes</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow060"
                          >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle226"
                        >
                          <span class="index-text0620"><a href="/FilterMotherBoard?wifi=0"><span>No</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow061"
                          >
              ...
              <div
                data-thq="thq-dropdown"
                class="index-thq-dropdown3 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  class="index-dropdown-toggle-cpu3"
                >
                ...
                <ul data-thq="thq-dropdown-list" class="index-dropdown-list072">
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown279 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle255"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list073"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown280 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle256"
                        >
                          <span class="index-text0705"><a href="/FilterPSU?efficiency=80platin"><span>80+ platin</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow068"
                          >
                          </div>
                        </div>                   
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown283 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle259"
                        >
                          <span class="index-text0712"><a href="/FilterPSU?efficiency=80gold"><span>80+ gold</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow069"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown287 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle263"
                        >
                          <span class="index-text0722"><a href="/FilterPSU?efficiency=80titani"><span>80+ titani</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow070"
                          >
                          </div>
                        </div>                       
                      </li>                     
              ...
              <div
                data-thq="thq-dropdown"
                class="index-thq-dropdown4 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  class="index-dropdown-toggle-cpu4"
                >
                ...
                <ul data-thq="thq-dropdown-list" class="index-dropdown-list096">
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown372 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle340"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list097"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown373 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle341"
                        >
                          <span class="index-text0935"><a href="/FilterRAM?generations=ddr4"><span>DDR4</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow090"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown376 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle344"
                        >
                          <span class="index-text0942"><a href="/FilterRAM?generations=ddr5"><span>DDR5</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow091"
                          >
                          </div>
                        </div>                       
                      </li>
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown398 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle366"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list104"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown399 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle367"
                        >
                          <span class="index-text1004"><a href="/FilterRAM?speed=3000"><span>3000</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow097"
                          >
                          </div>
                        </div>                      
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown402 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle370"
                        >
                          <span class="index-text1011"><a href="/FilterRAM?speed=3200"><span>3200</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow098"
                          >
                          </div>
                        </div>                        
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown406 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle374"
                        >
                          <span class="index-text1021"><a href="/FilterRAM?speed=3600"><span>3600</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow099"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown410 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle378"
                        >
                          <span class="index-text1031"><a href="/FilterRAM?speed=5600"><span>5600</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow100"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown413 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle381"
                        >
                          <span class="index-text1038"><a href="/FilterRAM?speed=6000"><span>6000</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow101"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown418 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle386"
                        >
                          <span class="index-text1052"><a href="/FilterRAM?speed=6400"><span>6400</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow102"
                          >
                          </div>
                        </div>                      
                      </li>
                  ...
                  <li
                    data-thq="thq-dropdown"
                    class="index-dropdown424 list-item"
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      class="index-dropdown-toggle392"
                    >
                    ...
                    <ul
                      data-thq="thq-dropdown-list"
                      class="index-dropdown-list111"
                    >
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown425 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle393"
                        >
                          <span class="index-text1073"><a href="/FilterRAM?latencys=15"><span>15</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow104"
                          >
                          </div>
                        </div>                        
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown428 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle396"
                        >
                          <span class="index-text1080"><a href="/FilterRAM?latencys=16"><span>16</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow105"
                          >
                          </div>
                        </div>
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown432 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle400"
                        >
                          <span class="index-text1090"><a href="/FilterRAM?latencys=18"><span>18</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow106"
                          >
                          </div>
                        </div>
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown436 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle404"
                        >
                          <span class="index-text1100"><a href="/FilterRAM?latencys=36"><span>36</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow107"
                          >
                          </div>
                        </div>                       
                      </li>
                      <li
                        data-thq="thq-dropdown"
                        class="index-dropdown439 list-item"
                      >
                        <div
                          data-thq="thq-dropdown-toggle"
                          class="index-dropdown-toggle407"
                        >
                          <span class="index-text1107"><a href="/FilterRAM?latencys=38"><span>38</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow108"
                          >
                          </div>
                        </div>                      
                      </li>
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle256"
                        >
                          <span class="index-text0705"> <a href="/FilterRAM?capacity=16"><span>16</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow068"
                          >
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle256"
                        >
                          <span class="index-text0705"><a href="/FilterSSD?interfaces=PCIe3"><span class="home-page-text443">PCIe 3.0</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow068"
                          >                           
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle259"
                        >
                          <span class="index-text0712"><a href="/FilterSSD?interfaces=PCIe4"><span class="home-page-text443">PCIe 4.0</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow069"
                          >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle263"
                        >
                          <span class="index-text0722"><a href="/FilterSSD?interfaces=SATA25"><span class="home-page-text443">SATA 2.5</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow070"
                          >
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle256"
                        >
                          <span class="index-text0705"><a href="/FilterSSD?cache=0"><span class="home-page-text443">0</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow068"
                          >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle259"
                        >
                          <span class="index-text0712"><a href="/FilterSSD?cache=1"><span class="home-page-text443">1</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow069"
                          >
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle256"
                        >
                          <span class="index-text0705"><a href="/FilterCase?formFactors=MidTower"><span class="home-page-text443">Mid Tower</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow068"
                          >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle259"
                        >
                          <span class="index-text0712"><a href="/FilterCase?formFactors=FullTower"><span class="home-page-text443">Full Tower</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow069"
                          >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle263"
                        >
                          <span class="index-text0722"><a href="/FilterCase?formFactors=MiniITX"><span class="home-page-text443">Mini ITX</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow070"
                          >
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle256"
                        >
                          <span class="index-text0705"> <a href="/FilterCase?colors=White"><span class="home-page-text443">White</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow068"
                          >
                      ...
                      >
                        <div
                          ...
                          class="index-dropdown-toggle259"
                        >
                          <span class="index-text0712"><a href="/FilterCase?colors=Black"><span class="home-page-text443">Black</span></a></span>
                          <div
                            data-thq="thq-dropdown-arrow"
                            class="index-dropdown-arrow069"
                          >
          ...
          <div class="index-cpu">
            ...
            <div class="index-body-cpu">
                <c:forEach var="cpu" items="${requestScope.cpus}" begin="0" end="4">
                    <a
                        href="/view/detail/product?category=cpu&id=${cpu.id}"
                        rel="noreferrer noopener"
                        >
                        <div class="product-container product-root-class-name131">
                            <img
          ...
          <div class="index-cpu2">
            ...
            <div class="index-body-cpu2">
                <c:forEach var="mobo" items="${requestScope.mobos}" begin="0" end="4">
                    <a
                href="/view/detail/product?category=mobo&id=${mobo.id}"
                rel="noreferrer noopener"
              >
          ...
          <div class="index-cpu3">
            ...
            <div class="index-body-cpu3">
                <c:forEach var="psu" items="${requestScope.psus}" begin="0" end="4">
                     <a
                href="/view/detail/product?category=psu&id=${psu.id}"         
                rel="noreferrer noopener"
              >
          ...
          <div class="index-cpu4">
            ...
            <div class="index-body-cpu4">
                <c:forEach var="ram" items="${requestScope.rams}" begin="0" end="4">
                    <a
                href="/view/detail/product?category=ram&id=${ram.id}"
                rel="noreferrer noopener"
              >
          ...
          <div class="index-cpu3">
            ...
            <div class="index-body-cpu4">
                <c:forEach var="case1" items="${requestScope.cases}" begin="0" end="4">
                    <a
                href="/view/detail/product?category=case&id=${case1.id}"
                rel="noreferrer noopener"
              >
                <div class="product-container product-root-class-name151">
                  <img
