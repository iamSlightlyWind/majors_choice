    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (service.equals("listAll")) {
            ...
            try {
                ...
                int result = db.addProductCase(sellingPrice, costPrice, name, formFactor, color, null, quantity);
                if (result != -1) {
                    int productId = db.getMaxProductId();
                    String image = db.handleFileUpload(request, "image", String.valueOf(productId));
                    int result1 = db.addProductCase(sellingPrice, costPrice, name, formFactor, color, image, quantity);
            ...
            if (submit == null) {
                ...
                int result = db.updateProductCase(id, sellingPrice, costPrice, name, formFactor, color, image, quantity);
